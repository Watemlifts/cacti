...
(function webpackUniversalModuleDefinition (root, factory) {
  ...
  return /******/ (function () { // webpackBootstrap
    ...
    !(function () {
      ...
      const resolver_shape_namespaceObject = {}
      ...
      const resolver_interaction_namespaceObject = {}
      ...
      const external_commonjs_d3_time_format_commonjs2_d3_time_format_amd_d3_time_format_root_d3_ = __webpack_require__(4)
      // EXTERNAL MODULE: external {"commonjs":"d3-selection","commonjs2":"d3-selection","amd":"d3-selection","root":"d3"}
      const external_commonjs_d3_selection_commonjs2_d3_selection_amd_d3_selection_root_d3_ = __webpack_require__(2)
 ...
 */
   ...
   */
      ...
      const external_commonjs_d3_brush_commonjs2_d3_brush_amd_d3_brush_root_d3_ = __webpack_require__(3)
 ...
 */
      ...
      const browser_doc = win && win.document
 ...
 */
      ...
      const ceil10 = function (v) {
        return Math.ceil(v / 10) * 10
      }
      const asHalfPixel = function (n) {
        return Math.ceil(n) + 0.5
      }
      const diffDomain = function (d) {
        return d[1] - d[0]
      }
      const isObjectType = function (v) {
 ...
 */
      ...
      function setTextValue (node, text, dy, toMiddle) {
        if (dy === void 0 && (dy = [-1, 1]), toMiddle === void 0 && (toMiddle = !1), node && isString(text)) {
 ...
 */
   ...
   * */
        ...
        const x = _path$getBBox.x
        const y = _path$getBBox.y
        const width = _path$getBBox.width
        const height = _path$getBBox.height
 ...
 */
      ...
      function getPathBox (path) {
        ...
        const width = _path$getBoundingClie.width
        const height = _path$getBoundingClie.height
 ...
 */
      ...
      function getPointer (event, element) {
        ...
        const pointer = event ? (0, external_commonjs_d3_selection_commonjs2_d3_selection_amd_d3_selection_root_d3_.pointer)(touches ? touches[0] : event, element) : [0, 0]
        return pointer
      }
      /**
 ...
 */
      ...
      function findIndex (arr, v, start, end, isRotated) {
        ...
        const _arr$mid = arr[mid]
        let x = _arr$mid.x
        const _arr$mid$w = _arr$mid.w
        let w = _arr$mid$w === void 0 ? 0 : _arr$mid$w
      ...
      function deepClone () {
        for (var clone = (function (_clone) {
            ...
            if (isObject(v) && v.constructor) {
              ...
              for (const k in v) r[k] = clone(v[k])
 ...
 */
      ...
      function extend (target, source) {
        ...
        for (const p in target === void 0 && (target = {}), isArray(source) && source.forEach(function (v) {
 ...
 */
      ...
      const getTranslation = function (node) {
 ...
 */
      ...
      function getUnique (data) {
        ...
        const d = (isDate ? data.map(Number) : data).filter(function (v, i, self) {
        ...
        mouse: (function () {
          ...
          try {
            ...
            return function (el, eventType, params) {
              ...
              const mouseEvent = browser_doc.createEvent('MouseEvent') // https://developer.mozilla.org/en-US/docs/Web/API/MouseEvent/initMouseEvent
 ...
 */
      ...
      function convertInputType (mouse, touch) {
        let isMobile = !1 // https://developer.mozilla.org/en-US/docs/Web/HTTP/Browser_detection_using_the_user_agent#Mobile_Tablet_or_Desktop

        if (/Mobi/.test(win.navigator.userAgent) && touch) {
          // Some Edge desktop return true: https://developer.microsoft.com/en-us/microsoft-edge/platform/issues/20417074/
          const hasTouchPoints = win.navigator && 'maxTouchPoints' in win.navigator && win.navigator.maxTouchPoints > 0
          const hasTouch = 'ontouchmove' in win || win.DocumentTouch && browser_doc instanceof win.DocumentTouch // Ref: https://github.com/Modernizr/Modernizr/blob/master/feature-detects/touchevents.js
          // On IE11 with IE9 emulation mode, ('ontouchstart' in window) is returning true

          isMobile = hasTouchPoints || hasTouch
        }

        const hasMouse = !(!mouse || isMobile) && 'onmouseover' in win
        return hasMouse && 'mouse' || isMobile && 'touch' || null
      }
      ;// CONCATENATED MODULE: ./src/config/Options/Options.ts

      function Options_ownKeys (object, enumerableOnly) { const keys = Object.keys(object); if (Object.getOwnPropertySymbols) { let symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable })), keys.push.apply(keys, symbols) } return keys }
 ...
 */
      ...
      const Cache = /* #__PURE__ */(function () {
        function Cache () {
          this.cache = {}
        }

        const _proto = Cache.prototype
        return _proto.add =
  /**
   * Add cache
   ...
   */
        , _proto.reset = function reset (all) {
          ...
          for (const x in $$.cache) (all || /^\$/.test(x)) && ($$.cache[x] = null)
        }
        /**
 ...
 */
      ...
      const generator_clearTimeout = win.clearTimeout
      /**
 ...
 */
    ...
    function loop() {
      ...
      const external_commonjs_d3_dsv_commonjs2_d3_dsv_amd_d3_dsv_root_d3_ = __webpack_require__(5)
 ...
 */
   ...
   */
        convertData: function convertData (args, callback) {
          let data
          if (args.bindto
            ? (data = {}, ['url', 'mimeType', 'headers', 'keys', 'json', 'keys', 'rows', 'columns'].forEach(function (v) {
                const key = 'data_' + v
   ...
   */
          ...
          if (isArray(json)) {
            ...
            keys.x ? (targetKeys = keys.value.concat(keys.x), config.data_x = keys.x) : targetKeys = keys.value, newRows.push(targetKeys), json.forEach(function (o) {
              const newRow = targetKeys.map(function (key) {
                ...
                let v = _this2.findValueInJson(o, key)
        ...
        findValueInJson: function findValueInJson (object, path) {
          ...
          let target = object // convert indexes to properties (replace [] with .)
        ...
        convertDataToTargets: function convertDataToTargets (data, appendXs) {
          ...
          ids.forEach(function (id) {
            const xKey = _this3.getXKey(id)

            isCustomX || isTimeSeries
              ? xs.indexOf(xKey) >= 0
                ...
                : config.data_x ? xsData = _this3.getOtherTargetXs() : notEmpty(config.data_xs) && (xsData = $$.getXValuesOfXKey(xKey, $$.data.targets))
          ...
          const targets = ids.map(function (id, index) {
            ...
            const hasCategory = isCategory && data.map(function (v) {
              return v.x
            }).every(function (v) {
 ...
 */
   ...
   */
        ...
        getValuesAsIdKeyed: function getValuesAsIdKeyed (targets) {
          ...
          const xs = isMultipleX
            ? $$.mapTargetsToUniqueXs(targets).map(function (v) {
          ...
          return targets.forEach(function (t) {
            ...
            t.values.filter(function (v) {
              ...
              let value = v.value // exclude 'volume' value to correct mis domain calculation
        ...
        checkValueInTargets: function checkValueInTargets (targets, checker) {
          ...
          for (let i = 0; i < ids.length; i++) {
            ...
            for (let j = 0; j < values.length; j++) if (checker(values[j].value)) return !0
          }
   ...
   */
        orderTargets: function orderTargets (targetsValue) {
          const $$ = this
          const targets = [].concat(targetsValue)
   ...
   */
        getDataIndexFromEvent: function getDataIndexFromEvent (event) {
          ...
          const config = $$.config
          const _$$$state = $$.state
          const inputType = _$$$state.inputType
          const _$$$state$eventReceiv = _$$$state.eventReceiver
          const coords = _$$$state$eventReceiv.coords
          const rect = _$$$state$eventReceiv.rect
          const isRotated = config.axis_rotated
          const e = inputType === 'touch' && event.changedTouches ? event.changedTouches[0] : event
          const index = findIndex(coords, isRotated ? e.clientY - rect.top : e.clientX - rect.left, 0, coords.length - 1, isRotated)
          return index
        },
        ...
        findClosestFromTargets: function findClosestFromTargets (targets, pos) {
          const $$ = this
          const candidates = targets.map(function (target) {
        ...
        findClosest: function findClosest (values, pos) {
          ...
          const config = $$.config
          const main = $$.$el.main
          const data = values.filter(function (v) {
          ...
          return data.filter(function (v) {
            ...
            const shape = main.select('.' + config_classes.bars + $$.getTargetSelectorSuffix(v.id) + ' .' + config_classes.bar + '-' + v.index).node()
   ...
   */
        convertValuesToStep: function convertValuesToStep (values) {
          ...
          const isCategorized = !!axis && axis.isCategorized()
        ...
        getRatio: function getRatio (type, d, asPercent) {
          ...
          if (d && api.data.shown().length) {
            ...
            // if has padAngle set, calculate rate based on value
              ...
              const max = yScale.domain().reduce(function (a, c) {
                return c - a
              })
   ...
   */
        updateDataIndexByX: function updateDataIndexByX (tickValues) {
          const $$ = this
          const tickValueMap = tickValues.reduce(function (out, tick, index) {
 ...
 */
      ...
      /* harmony default export */ const load = ({
        ...
        loadFromArgs: function loadFromArgs (args) {
          const $$ = this // prevent load when chart is already destroyed

          if ($$.config) {
            $$.cache.reset()
            const data = args.data || $$.convertData(args, function (d) {
      ...
      const external_commonjs_d3_drag_commonjs2_d3_drag_amd_d3_drag_root_d3_ = __webpack_require__(7)
 ...
 */
        ...
        setOverOut: function setOverOut (isOver, d) {
          ...
          if (isArc || d !== -1) {
            ...
            if (config.color_onover && $$.setOverColor(isOver, d, isArc), isArc) callback(d, main.select('.' + config_classes.arc + $$.getTargetSelectorSuffix(d.id)).node()); else if (!config.tooltip_grouped) {
              ...
              const shape = main.selectAll('.' + config_classes.shape + '-' + d).filter(function (d) {
                return $$.isWithinShape(this, d)
              })
              ...
              isOver && (config.point_focus_only && hasRadar ? $$.showCircleFocus($$.getAllValuesOnIndex(d, !0)) : $$.expandCirclesBars(d, null, !0)), $$.isMultipleX() || main.selectAll('.' + config_classes.shape + '-' + d).each(function (d) {
                callback(d, this)
              })
            }
          }
   ...
   */
        getDraggableSelection: function getDraggableSelection () {
          ...
          return config.interaction_enabled && config.data_selection_draggable && $$.drag
            ? (0, external_commonjs_d3_drag_commonjs2_d3_drag_amd_d3_drag_root_d3_.drag)().on('drag', function (event) {
   ...
   */
        dispatchEvent: function dispatchEvent (type, index, mouse) {
          ...
          const config = $$.config
          const _$$$state = $$.state
          const eventReceiver = _$$$state.eventReceiver
          const hasAxis = _$$$state.hasAxis
          const hasRadar = _$$$state.hasRadar
          const _$$$$el2 = $$.$el
          const eventRect = _$$$$el2.eventRect
          const arcs = _$$$$el2.arcs
          const radar = _$$$$el2.radar
          const isMultipleX = $$.isMultipleX()
          const element = (hasRadar
            ? radar.axes.select('.' + config_classes.axis + '-' + index + ' text')
            : eventRect || arcs.selectAll('.' + config_classes.target + ' path').filter(function (d, i) {
              return i === index
            })).node()
          ...
          let top = _element$getBoundingC.top
 ...
 */
   ...
   */
        getClass: function getClass (type, withShape) {
          ...
          return function (d) {
            const data = d.data || d
            const result = (withShape ? _this.generateClass(config_classes[isPlural ? 'shapes' : 'shape'], data[key]) : '') + _this.generateClass(config_classes[type], data[useIdKey ? 'id' : key])
 ...
 */
   ...
   */
      ...
      const external_commonjs_d3_scale_commonjs2_d3_scale_amd_d3_scale_root_d3_ = __webpack_require__(6)
 ...
 */
      ...
      const schemeCategory10 = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd', '#8c564b', '#e377c2', '#7f7f7f', '#bcbd22', '#17becf'] // Replacement of d3.schemeCategory10.
   ...
   */
        getColorFromCss: function getColorFromCss () {
          ...
          const body = browser_doc.body
          let pattern = body[cacheKey]

          if (!pattern) {
            const span = browser_doc.createElement('span')
            span.className = config_classes.colorPattern, span.style.display = 'none', body.appendChild(span)
            const content = win.getComputedStyle(span).backgroundImage
        ...
        generateColor: function generateColor () {
          ...
          const ids = []
          let pattern = notEmpty(config.color_pattern) ? config.color_pattern : (0, external_commonjs_d3_scale_commonjs2_d3_scale_amd_d3_scale_root_d3_.scaleOrdinal)($$.getColorFromCss() || schemeCategory10).range()
          const originalColorPattern = pattern

          if (isFunction(config.color_tiles)) {
            const tiles = config.color_tiles.bind($$.api)()
            const colorizedPatterns = pattern.map(function (p, index) {
 ...
 */
   ...
   */
        ...
        getYDomain: function getYDomain (targets, axisId, xDomain) {
          ...
          const targetsByAxisId = targets.filter(function (t) {
          ...
          let isZeroBased = [TYPE.BAR, TYPE.BUBBLE, TYPE.SCATTER].concat(TYPE_BY_CATEGORY.Line).some(function (v) {
          ...
          const padding = {
            top: domainLength * 0.1,
            bottom: domainLength * 0.1
          }
          ...
          if (showHorizontalDataLabel) {
            ...
            const ratio = $$.getDataLabelLength(yDomainMin, yDomainMax, 'width').map(function (v) {
              return v / diff
            });
          ...
          const domain = isLog
            ? [yDomainMin, yDomainMax].map(function (v) {
                return v < 0 ? 0 : v
              })
        ...
        getXDomainMinMax: function getXDomainMinMax (targets, type) {
          ...
          const dataValue = getMinMax(type, targets.map(function (t) {
        ...
        getXDomainPadding: function getXDomainPadding (domain) {
          ...
          axis.isCategorized() ? padding = 0 : $$.hasType('bar') ? (maxDataCount = $$.getMaxDataCount(), padding = maxDataCount > 1 ? diff / (maxDataCount - 1) / 2 : 0.5) : padding = diff * 0.01
          let left = padding
          let right = padding
        ...
        getXDomain: function getXDomain (targets) {
          ...
          if (isLog) min = xDomain[0], max = xDomain[1]; else {
            ...
            let firstX = _xDomain[0]
            let lastX = _xDomain[1]
            firstX - lastX !== 0 || isCategorized || (isTimeSeries ? (firstX = new Date(firstX.getTime() * 0.5), lastX = new Date(lastX.getTime() * 1.5)) : (firstX = firstX === 0 ? 1 : firstX * 0.5, lastX = lastX === 0 ? -1 : lastX * 1.5)), (firstX || firstX === 0) && (min = isTimeSeries ? new Date(firstX.getTime() - padding.left) : firstX - padding.left), (lastX || lastX === 0) && (max = isTimeSeries ? new Date(lastX.getTime() + padding.right) : lastX + padding.right)
          }
          return [min, max]
        },
   ...
   */
        getZoomDomain: function getZoomDomain () {
          ...
          const config = $$.config
          const org = $$.org
          const _org$xDomain = org.xDomain
          let min = _org$xDomain[0]
          let max = _org$xDomain[1]
 ...
 */
      ...
      /* harmony default export */ const format = ({
        ...
        dataLabelFormat: function dataLabelFormat (targetId) {
          ...
          const defaultFormat = function (v) {
            return isValue(v) ? +v : ''
          }
          let format = defaultFormat

          return isFunction(dataLabels.format)
            ? format = dataLabels.format
            : isObjectType(dataLabels.format) && (dataLabels.format[targetId]
 ...
 */
   ...
   */
        updateSizeForLegend: function updateSizeForLegend (size) {
          ...
          const config = $$.config
          const _$$$state = $$.state
          const isLegendTop = _$$$state.isLegendTop
          const isLegendLeft = _$$$state.isLegendLeft
          const isLegendRight = _$$$state.isLegendRight
          const isLegendInset = _$$$state.isLegendInset
          const current = _$$$state.current
   ...
   */
        getLegendWidth: function getLegendWidth () {
          const $$ = this
          const _$$$state2 = $$.state
          const width = _$$$state2.current.width
          const isLegendRight = _$$$state2.isLegendRight
          const isLegendInset = _$$$state2.isLegendInset
          const legendItemWidth = _$$$state2.legendItemWidth
          const legendStep = _$$$state2.legendStep
   ...
   */
        getLegendHeight: function getLegendHeight () {
          const $$ = this
          const _$$$state3 = $$.state
          const current = _$$$state3.current
          const isLegendRight = _$$$state3.isLegendRight
          const legendItemHeight = _$$$state3.legendItemHeight
          const legendStep = _$$$state3.legendStep
   ...
   */
        updateLegendElement: function updateLegendElement (targetIds, options) {
          ...
          const updatePositions = function (textElement, id, index) {
            ...
            const itemWidth = box.width + tileWidth + (isLast && !isLegendRightOrInset ? 0 : 10) + config.legend_padding
            const itemHeight = box.height + 4
            ...
            config.legend_equally
              ? (Object.keys(widths).forEach(function (id2) {
                ...
                }), margin = (areaLength - maxLength * targetIdz.length) / 2, margin < posMin
                  ? (totalLength = 0, step = 0, targetIdz.forEach(function (id2) {
          ...
          state.isLegendInset && (step = config.legend_inset_step ? config.legend_inset_step : targetIdz.length, $$.updateLegendStep(step)), state.isLegendRight
          ...
          const xForLegendText = function (id, i) {
            return xForLegend(id, i) + 4 + config.legend_item_tile_width
          }
          const xForLegendRect = function (id, i) {
            return xForLegend(id, i)
          }
          const x1ForLegendTile = function (id, i) {
            return xForLegend(id, i) - 2
          }
          const x2ForLegendTile = function (id, i) {
            return xForLegend(id, i) - 2 + config.legend_item_tile_width
          }
          const yForLegendText = function (id, i) {
            return yForLegend(id, i) + 9
          }
          const yForLegendRect = function (id, i) {
            return yForLegend(id, i) - 5
          }
          const yForLegendTile = function (id, i) {
            return yForLegend(id, i) + 4
          }
          const pos = -200
          const l = legend.selectAll('.' + config_classes.legendItem).data(targetIdz).enter().append('g')
          ...
          const rects = legend.selectAll('rect.' + config_classes.legendItemEvent).data(targetIdz)
          ...
          if ((withTransition ? rects.transition() : rects).attr('width', function (id) {
            ...
            const tiles = legend.selectAll('.' + config_classes.legendItemPoint).data(targetIdz);
            ...
            const _tiles = legend.selectAll('line.' + config_classes.legendItemTile).data(targetIdz);
      ...
      const external_commonjs_d3_transition_commonjs2_d3_transition_amd_d3_transition_root_d3_ = __webpack_require__(8)
 ...
 */
      ...
      /* harmony default export */ const redraw = ({
        redraw: function redraw (options) {
          ...
          // text
          // title
          $$.updateSizes(initializing), wth.Legend && config.legend_show ? (options.withTransition = !!duration, $$.updateLegend($$.mapToIds($$.data.targets), options, transitions)) : wth.Dimension && $$.updateDimension(!0), (!$$.hasArcType() || state.hasRadar) && $$.updateCircleY && ($$.circleY = $$.updateCircleY()), state.hasAxis
            ? ($$.axis.redrawAxis(targetsToShow, wth, transitions, flow, initializing), config.data_empty_label_text && main.select('text.' + config_classes.text + '.' + config_classes.empty).attr('x', state.width / 2).attr('y', state.height / 2).text(config.data_empty_label_text).style('display', targetsToShow.length ? 'none' : null), $$.hasGrid() && $$.updateGrid(duration), config.regions.length && $$.updateRegion(duration), ['bar', 'candlestick', 'line', 'area'].forEach(function (v) {
                const name = capitalize(v);
                (/^(line|area)$/.test(v) && $$.hasTypeOf(name) || $$.hasType(v)) && $$['update' + name](durationForExit)
              }), $el.text && main.selectAll('.' + config_classes.selectedCircles).filter($$.isBarType.bind($$)).selectAll('circle').remove(), config.interaction_enabled && !flow && wth.EventRect && ($$.redrawEventRect(), $$.bindZoomEvent && $$.bindZoomEvent()))
            : ($el.arcs && $$.redrawArc(duration, durationForExit, wth.Transform), $el.radar && $$.redrawRadar(durationForExit)), !state.resizing && ($$.hasPointType() || state.hasRadar) && $$.updateCircle(), $$.hasDataLabel() && !$$.hasArcType(null, ['radar']) && $$.updateText(durationForExit), $$.redrawTitle && $$.redrawTitle(), initializing && $$.updateTypesElements(), $$.generateRedrawList(targetsToShow, flow, duration, wth.Subchart), $$.callPluginHook('$redraw', options, duration)
        },
   ...
   */
        generateRedrawList: function generateRedrawList (targets, flow, duration, withSubchart) {
          ...
          if (afterRedraw) // Only use transition when current tab is visible.
          {
            ...
            // Wait for end of transitions for callback
              const waitForDraw = generateWait(); // transition should be derived from one transition
        ...
        getRedrawList: function getRedrawList (shape, flow, flowFn, isTransition) {
          ...
          const hasRadar = _$$$state.hasRadar
          const grid = $$.$el.grid
          const _shape$pos = shape.pos
          const cx = _shape$pos.cx
          const cy = _shape$pos.cy
          const xForText = _shape$pos.xForText
          const yForText = _shape$pos.yForText
          const list = []
 ...
 */
   ...
   */
        getCustomizedScale: function getCustomizedScale (scaleValue, offsetValue) {
          const $$ = this
          const offset = offsetValue || function () {
   ...
   */
        updateScales: function updateScales (isInit, updateXDomain) {
          ...
          const scale = $$.scale
          const _$$$state = $$.state
          const width = _$$$state.width
          const height = _$$$state.height
          const width2 = _$$$state.width2
          const height2 = _$$$state.height2
          const hasAxis = _$$$state.hasAxis
          ...
          if (hasAxis) {
            ...
            const xSubDomain = updateXDomain && org.xDomain // update edges
   ...
   */
        ...
        yv: function yv (d) {
          const $$ = this
          const _$$$scale2 = $$.scale
          const y = _$$$scale2.y
          const y2 = _$$$scale2.y2
      ...
      const external_commonjs_d3_shape_commonjs2_d3_shape_amd_d3_shape_root_d3_ = __webpack_require__(9)
 ...
 */
   ...
   */
        ...
        getShapeIndices: function getShapeIndices (typeFilter) {
          ...
          return hasXs && getUnique(Object.keys(xs).map(function (v) {
            ...
            for (var groups, xKey = (d.id in xs) ? xs[d.id] : '', ind = xKey ? indices[xKey] : indices, j = 0; groups = config.data_groups[j]; j++) {
   ...
   */
        getShapeYMin: function getShapeYMin (id) {
          ...
          const _scale$domain = scale.domain()
          const yMin = _scale$domain[0]
   ...
   */
        getShapeOffsetData: function getShapeOffsetData (typeFilter) {
          ...
          const isStackNormalized = $$.isStackNormalized()
          const shapeOffsetTargets = targets.map(function (target) {
          ...
          const indexMapByTargetId = targets.reduce(function (out, _ref, index) {
            const id = _ref.id
        ...
        getShapeOffset: function getShapeOffset (typeFilter, indices, isSub) {
          const $$ = this
          const _$$$getShapeOffsetDat = $$.getShapeOffsetData(typeFilter)
          const shapeOffsetTargets = _$$$getShapeOffsetDat.shapeOffsetTargets
          const indexMapByTargetId = _$$$getShapeOffsetDat.indexMapByTargetId

          return function (d, idx) {
            const ind = $$.getIndices(indices, d.id)
            const scale = $$.getYScaleById(d.id, isSub)
            const y0 = scale($$.getShapeYMin(d.id))
            const dataXAsNumber = +d.x
            let offset = y0
            return shapeOffsetTargets.filter(function (t) {
              return t.id !== d.id
            }).forEach(function (t) {
              if (ind[t.id] === ind[d.id] && indexMapByTargetId[t.id] < indexMapByTargetId[d.id]) {
                let row = t.rowValues[idx] // check if the x values line up
 ...
 */
   ...
   */
        ...
        getCurrentPaddingBottom: function getCurrentPaddingBottom () {
          ...
          const padding = isValue(config.padding_bottom) ? config.padding_bottom : 0
        ...
        getCurrentPaddingRight: function getCurrentPaddingRight (withXAxisTickTextOverflow) {
          ...
          const xAxisTickTextOverflow = withXAxisTickTextOverflow ? $$.axis.getXAxisTickTextY2Overflow(defaultPadding) : 0
   ...
   */
        getParentRectValue: function getParentRectValue (key) {
          ...
          if (key === 'width') {
            ...
            const bodyWidth = browser_doc.body.offsetWidth
        ...
        getSvgLeft: function getSvgLeft (withoutRecompute) {
          ...
          const leftAxisClass = config.axis_rotated ? config_classes.axisX : config_classes.axisY
          ...
          const svgLeft = svgRect.right - chartRect.left - (hasArc ? 0 : $$.getCurrentPaddingLeft(withoutRecompute))
        ...
        updateSvgSize: function updateSvgSize () {
          ...
          if (svg.attr('width', current.width).attr('height', current.height), hasAxis) {
            const brush = svg.select('.' + config_classes.brush + ' .overlay')
            const brushSize = {
              width: 0,
              height: 0
            }
   ...
   */
        updateSizes: function updateSizes (isInit) {
          ...
          const subchartHeight = config.subchart_show && !hasArc ? config.subchart_size_height + subchartXAxisHeight : 0
 ...
 */
   ...
   */
        updateTargetsForText: function updateTargetsForText (targets) {
          ...
          const mainTextUpdate = $$.$el.main.select('.' + config_classes.chartTexts).selectAll('.' + config_classes.chartText).data(targets).attr('class', function (d) {
            return classChartText(d) + classFocus(d)
          })
          const mainTextEnter = mainTextUpdate.enter().append('g').style('opacity', '0').attr('class', classChartText).style('pointer-events', 'none')
   ...
   */
        updateText: function updateText (durationForExit) {
          ...
          const text = $el.main.selectAll('.' + config_classes.texts).selectAll('.' + config_classes.text).data($$.labelishData.bind($$))
   ...
   */
        redrawText: function redrawText (x, y, forFlow, withTransition) {
          ...
          return $$.$el.text.style('fill', $$.updateTextColor.bind($$)).style('fill-opacity', forFlow ? 0 : $$.opacityForText.bind($$)).each(function (d, i) {
            ...
            const node = withTransition && this.getAttribute('x') ? (0, external_commonjs_d3_selection_commonjs2_d3_selection_amd_d3_selection_root_d3_.select)(this).transition(t) : (0, external_commonjs_d3_selection_commonjs2_d3_selection_amd_d3_selection_root_d3_.select)(this)
   ...
   */
        generateXYForText: function generateXYForText (indices, forX) {
          ...
          return $$.hasType('radar') && types.push('radar'), types.forEach(function (v) {
            ...
            const type = $$.isAreaType(d) && 'area' || $$.isBarType(d) && 'bar' || $$.isCandlestickType(d) && 'candlestick' || $$.isRadarType(d) && 'radar' || 'line'
        ...
        getXForText: function getXForText (points, d, textElement) {
          ...
          if (d.value === null) {
            if (xPos > state.width) {
              ...
              const width = _getBoundingRect.width
   ...
   */
        markOverlapped: function markOverlapped (id, $$, selector) {
          ...
          const filteredTextNodes = textNodes.filter(function (node) {
            return node.data.id !== id
          })
          const textNode = textNodes.filter(function (node) {
            return node.data.id === id
          })
          const translate = getTranslation(textNode.node())
          const calcHypo = function (x, y) {
 ...
 */
   ...
   */
        initTitle: function initTitle () {
          ...
          if (config.title_text) {
            ...
            const text = $el.title.append('text').style('text-anchor', getTextPos(config.title_position)).attr('class', config_classes.title)
   ...
   */
        xForTitle: function xForTitle () {
          ...
          const textRectWidth = $$.getTextRect($$.$el.title, config_classes.title).width
 ...
 */
   ...
   */
        getTooltipContent: function getTooltipContent (d, defaultTitleFormat, defaultValueFormat, color) {
          ...
          const config = $$.config
          const state = $$.state
          const _map = ['title', 'name', 'value'].map(function (v) {
            const fn = config['tooltip_format_' + v]
            return isFunction(fn) ? fn.bind(api) : fn
          })
          let titleFormat = _map[0]
          let nameFormat = _map[1]
          let valueFormat = _map[2]

          titleFormat = titleFormat || defaultTitleFormat, nameFormat = nameFormat || function (name) {
            return name
          }, valueFormat = valueFormat || ($$.isStackNormalized()
            ? function (v, ratio) {
          ...
          for (i = 0; i < len; i++) {
            if (row = d[i], row && (getRowValue(row) || getRowValue(row) === 0)) {
              if (isUndefined(text)) {
   ...
   */
        showTooltip: function showTooltip (selectedData, element) {
          ...
          const dataToShow = selectedData.filter(function (d) {
          ...
          if (tooltip && dataToShow.length !== 0 && config.tooltip_show) {
            ...
            let width = _ref$width === void 0 ? 0 : _ref$width
            const _ref$height = _ref.height
            let height = _ref$height === void 0 ? 0 : _ref$height
            ...
            if (!bindto) {
              ...
              const pos = fnPos.call(this, dataToShow, width, height, element); // Get tooltip dimensions
   ...
   */
        bindTooltipResizePos: function bindTooltipResizePos () {
          const $$ = this
          const resizeFunction = $$.resizeFunction
          const state = $$.state
          const tooltip = $$.$el.tooltip
          resizeFunction.add(function () {
            if (tooltip.style('display') === 'block') {
              const current = state.current
              const _tooltip$datum = tooltip.datum()
              const width = _tooltip$datum.width
              const xPosInPercent = _tooltip$datum.xPosInPercent
              let _value = current.width / 100 * xPosInPercent
              const diff = current.width - (_value + width)
        ...
        _handleLinkedCharts: function _handleLinkedCharts (show, index) {
          ...
          if (event && event.isTrusted && config.tooltip_linked && charts.length > 1) {
            ...
            charts.filter(function (c) {
              ...
              const config = _c$internal.config
              const $el = _c$internal.$el
 ...
 */
      ...
      /* harmony default export */ const type = ({
        setTargetType: function setTargetType (targetIds, type) {
          const $$ = this
          const config = $$.config
          const withoutFadeIn = $$.state.withoutFadeIn
   ...
   */
        hasType: function hasType (type, targetsValue, checkFromData) {
          ...
          let has = !1
          return !checkFromData && current.types.length && current.types.indexOf(type) > -1
            ? has = !0
   ...
   */
        labelishData: function labelishData (d) {
          return this.isBarType(d) || this.isLineType(d) || this.isScatterType(d) || this.isBubbleType(d) || this.isCandlestickType(d) || this.isRadarType(d)
            ? d.values.filter(function (v) {
 ...
 */
      ...
      const ChartInternal = /* #__PURE__ */(function () {
        // API interface
        // config object
        // cache instance
        // elements
        ...
        const _proto = ChartInternal.prototype
   ...
   */
        , _proto.initToRender = function initToRender (forced) {
          ...
          const subY = scale.subY
          const subY2 = scale.subY2 // Set domains for each scale
          ...
          // Define regions
          const main = $el.svg.append('g').classed(config_classes.main, !0).attr('transform', $$.getTranslate('main'))
          ...
          const $$ = this
          const _$$$$el = $$.$el
          const chart = _$$$$el.chart
          const svg = _$$$$el.svg
          const defs = _$$$$el.defs
          const main = _$$$$el.main
          const tooltip = _$$$$el.tooltip
          const legend = _$$$$el.legend
          const title = _$$$$el.title
          const grid = _$$$$el.grid
          const arc = _$$$$el.arcs
          const circles = _$$$$el.circle
          const bars = _$$$$el.bar
          const candlestick = _$$$$el.candlestick
          const lines = _$$$$el.line
          const areas = _$$$$el.area
          const texts = _$$$$el.text
          $$.api.$ = {
            chart,
            svg,
            defs,
   ...
   */
        , _proto.updateTargets = function updateTargets (targets) {
          const $$ = this
          const _$$$state2 = $$.state
          const hasAxis = _$$$state2.hasAxis
          const hasRadar = _$$$state2.hasRadar
          $$.updateTargetsForText(targets), hasAxis
            ...
            : $$.hasArcType(targets) && (hasRadar ? $$.updateTargetsForRadar(targets.filter($$.isRadarType.bind($$))) : $$.updateTargetsForArc(targets.filter($$.isArcType.bind($$)))), ($$.hasType('bubble') || $$.hasType('scatter')) && $$.updateTargetForCircle && $$.updateTargetForCircle(), $$.showTargets()
        }
        /**
 ...
 */
   ...
   */
        flush: function flush (soft) {
          ...
          const state = $$.state
          state.rendered
            ? (state.resizing ? $$.brush && $$.brush.updateResize() : $$.axis && $$.axis.setOrient(), $$.scale.zoom = null, soft
                ? $$.redraw({
                  withTransform: !0,
                  withUpdateXDomain: !0,
                  withUpdateOrgXDomain: !0,
                ...
                : $$.updateAndRedraw({
                  ...
                  withTransition: !1,
                  withTransitionForTransform: !1
                }), !state.resizing && $$.brush && ($$.brush.getSelection().call($$.brush.move), $$.unselectRect()))
            : $$.initToRender(!0)
        },
   ...
   */
        destroy: function destroy () {
          ...
          {
            for (const _key in $$.callPluginHook('$willDestroy'), $$.charts.splice($$.charts.indexOf(this), 1), svg.select('*').interrupt(), $$.resizeFunction.clear(), win.removeEventListener('resize', $$.resizeFunction), chart.classed('bb', !1).html(''), Object.keys(this).forEach(function (key) {
 ...
 */
      ...
      function nodeToSvgDataUrl (node, option, orgSize) {
        ...
        const cssText = getCssRules(toArray(browser_doc.styleSheets)).filter(function (r) {
          return r.cssText
        }).map(function (r) {
          return r.cssText
        })
        ...
        const style = browser_doc.createElement('style') // escape css for XML
   ...
   */
        export: function _export (option, callback) {
          ...
          const width = _state$current.width
          const height = _state$current.height
          const opt = mergeObj({
            width,
            height,
          ...
          const svgDataUrl = nodeToSvgDataUrl(chart.node(), opt, {
            width,
            height
          })
 ...
 */
   ...
   */
        hide: function hide () {
          ...
          if (data) {
            const index = JSON.parse(data.current)[0].index; // make to finalize, possible pending event flow set from '.tooltip.show()' call
 ...
 */
      ...
      const Chart = function Chart (options) {
 ...
 */
   ...
   */
        range: function range (_range) {
          ...
          if (arguments.length) isDefined(_range.max) && axis.max(_range.max), isDefined(_range.min) && axis.min(_range.min); else {
            return {
              max: axis.max(),
              min: axis.min()
            }
 ...
 */
   ...
   */
        remove: function remove (optionsValue) {
          ...
          const classes = getOption(options, 'classes', [config_classes.region])
          let regions = $$.$el.main.select('.' + config_classes.regions).selectAll(classes.map(function (c) {
            return '.' + c
          }))
          return (duration ? regions.transition().duration(duration) : regions).style('opacity', '0').remove(), regions = config.regions, Object.keys(options).length
 ...
 */
   ...
   */
        x: function x (_x) {
          ...
          return isArray(_x) && (isCategorized
            ? this.categories(_x)
            : ($$.updateTargetX(data.targets, _x), $$.redraw({
                withUpdateOrgXDomain: !0,
                withUpdateXDomain: !0
   ...
   */
        flow: function flow (args) {
          ...
          if ((args.json || args.rows || args.columns) && (data = $$.convertData(args)), data && isTabVisible()) {
            ...
            const targets = $$.convertDataToTargets(data, !0)
            const isTimeSeries = $$.axis.isTimeSeries()
            $$.data.targets.forEach(function (t) {
              for (var found = !1, i = 0; i < targets.length; i++) {
                if (t.id === targets[i].id) {
                  found = !0, t.values[t.values.length - 1] && (tail = t.values[t.values.length - 1].index + 1), length = targets[i].values.length

                  for (let _j3 = 0; _j3 < length; _j3++) targets[i].values[_j3].index = tail + _j3, isTimeSeries || (targets[i].values[_j3].x = tail + _j3)
              ...
              for (let _i = 0; _i < notfoundIds.length; _i++) {
                if (t.id === notfoundIds[_i]) {
                  tail = t.values[t.values.length - 1].index + 1

                  for (let _j4 = 0; _j4 < length; _j4++) {
                    t.values.push({
                      id: t.id,
                      index: tail + _j4,
              ...
              for (var missing = [], i = $$.data.targets[0].values[0].index; i < tail; i++) {
                missing.push({
                  id: t.id,
                  index: i,
            ...
            isDefined(args.to)
              ? (length = 0, to = isTimeSeries ? parseDate.call($$, args.to) : args.to, baseTarget.values.forEach(function (v) {
                  v.x < to && length++
                }))
      ...
      const external_commonjs_d3_axis_commonjs2_d3_axis_amd_d3_axis_root_d3_ = __webpack_require__(10)
 ...
 */
      ...
      const AxisRendererHelper = /* #__PURE__ */(function () {
        ...
        AxisRendererHelper.getSizeFor1Char = function getSizeFor1Char (node) {
          ...
          return node.empty() || node.select('text').text('0').call(function (el) {
            try {
              ...
              const width = _el$node$getBBox.width
              const height = _el$node$getBBox.height
   ...
   */
        ...
        const _proto = AxisRendererHelper.prototype
        return _proto.getTickTransformSetter = function getTickTransformSetter (id) {
          ...
          const _scale$domain = scale.domain()
          const start = _scale$domain[0]
          const end = _scale$domain[1]
          let ticks = []

          // When 'axis[y|y2].tick.stepSize' option is set
          if (isYAxes && tickStepSize) for (let interval = start; interval <= end;) ticks.push(interval), interval += tickStepSize; else if (scale.ticks) {
            const tickArguments = this.config.tickArguments // adjust excessive tick count show
            ...
            for (let i = Math.ceil(start); i < end; i++) ticks.push(i)
          ...
          const value = /\d+\.\d+0{5,}\d$/.test(v) ? +(v + '').replace(/0+\d$/, '') : v
          const formatted = tickFormat ? tickFormat(value) : value // to round float numbers from 'binary floating point'
 ...
 */
      ...
      const AxisRenderer = /* #__PURE__ */(function () {
   ...
   */
        ...
        const _proto = AxisRenderer.prototype
        return _proto.create = function create (g) {
          const ctx = this
          const config = this.config
          const helper = this.helper
          const params = this.params
          const scale = helper.scale
          ...
          const innerTickSize = _config2.innerTickSize
          const tickLength = _config2.tickLength
          const range = _config2.range
          const id = params.id
          ...
          g.each(function () {
            ...
            const path = g.selectAll('.domain').data([0]) // enter + update selection
            ...
            if (path.enter().append('path').attr('class', 'domain') // https://observablehq.com/@d3/d3-selection-2-0
              ...
              const tickEnter = tick.enter().insert('g', '.domain').attr('class', 'tick').style('opacity', '1')
              const tickExit = tick.exit().remove() // update selection
   ...
   */
        , _proto.getTickSize = function getTickSize (d) {
          ...
          const config = this.config
          const _config3 = config
          const innerTickSize = _config3.innerTickSize
          const range = _config3.range
   ...
   */
        , _proto.setTickLineTextPosition = function setTickLineTextPosition (lineUpdate, textUpdate) {
          ...
          const innerTickSize = _this$config.innerTickSize
          const orient = _this$config.orient
          const tickLength = _this$config.tickLength
          const tickOffset = _this$config.tickOffset
          const rotate = this.params.tickTextRotate
          const textAnchorForText = function (r) {
            const value = ['start', 'end']
            return orient === 'top' && value.reverse(), r ? r > 0 ? value[0] : value[1] : 'middle'
          }
          const textTransform = function (r) {
            return r ? 'rotate(' + r + ')' : null
          }
          const yForText = function (r) {
   ...
   */
        , _proto.tickInterval = function tickInterval (size) {
          ...
          if (this.params.isCategory) interval = this.config.tickOffset * 2; else {
            const length = this.g.select('path.domain').node().getTotalLength() - this.config.outerTickSize * 2
            interval = length / (size || this.g.selectAll('line').size())
            // get the interval by its values
            const intervalByValue = this.config.tickValues.map(function (v, i, arr) {
              const next = i + 1
 ...
 */
      ...
      var Axis_Axis = /* #__PURE__ */(function () {
        ...
        return _proto.getAxisClassName = function getAxisClassName (id) {
          ...
          const config = _this$owner.config
          const state = _this$owner.state
          ...
          const _$$$$el = $$.$el
          const main = _$$$$el.main
          const axis = _$$$$el.axis
          const clip = $$.state.clip
          const isRotated = config.axis_rotated
          const target = ['x', 'y']

          config.axis_y2_show && target.push('y2'), target.forEach(function (v) {
            const classAxis = _this.getAxisClassName(v)
            const classLabel = config_classes['axis' + v.toUpperCase() + 'Label']
   ...
   */
        , _proto.setOrient = function setOrient () {
          ...
          const isRotated = _$$$config.axis_rotated
          const yInner = _$$$config.axis_y_inner
          const y2Inner = _$$$config.axis_y2_inner
          this.orient = {
   ...
   */
        , _proto.generateAxes = function generateAxes (id) {
          ...
          id === 'x' ? d3Axis = isRotated ? external_commonjs_d3_axis_commonjs2_d3_axis_amd_d3_axis_root_d3_.axisLeft : external_commonjs_d3_axis_commonjs2_d3_axis_amd_d3_axis_root_d3_.axisBottom : id === 'y' ? d3Axis = isRotated ? external_commonjs_d3_axis_commonjs2_d3_axis_amd_d3_axis_root_d3_.axisBottom : external_commonjs_d3_axis_commonjs2_d3_axis_amd_d3_axis_root_d3_.axisLeft : id === 'y2' && (d3Axis = isRotated ? external_commonjs_d3_axis_commonjs2_d3_axis_amd_d3_axis_root_d3_.axisTop : external_commonjs_d3_axis_commonjs2_d3_axis_amd_d3_axis_root_d3_.axisRight), axesConfig.length && axesConfig.forEach(function (v) {
            ...
            v.domain && scale.domain(v.domain), axes.push(d3Axis(scale).ticks(tick.count).tickFormat(isFunction(tick.format)
              ? tick.format.bind($$.api)
              : function (x) {
                return x
        ...
        , _proto.updateAxes = function updateAxes () {
          ...
          Object.keys(this.axesList).forEach(function (id) {
            ...
            _this2.axesList[id].forEach(function (v, i) {
              const axisRange = v.scale().range() // adjust range value with the current
              // https://github.com/naver/billboard.js/issues/859

              range.every(function (v, i) {
                return v === axisRange[i]
              }) || v.scale().range(range)
              const className = _this2.getAxisClassName(id) + '-' + (i + 1)
   ...
   */
        ...
        , _proto.getAxis = function getAxis (id, scale, outerTick, noTransition, noTickTextRotate) {
          ...
          if (isX && this.isTimeSeries() && tickValues && !isFunction(tickValues)) {
            const _fn = parseDate.bind($$)

            tickValues = tickValues.map(function (v) {
              return _fn(v)
            })
          } else {
            !isX && this.isTimeSeriesY() && ( // https://github.com/d3/d3/blob/master/CHANGES.md#time-intervals-d3-time
          ...
          const config = _this$owner2.config
          const scale = _this$owner2.scale
          ...
          return tickFormat
            ? isFunction(tickFormat)
              ? currFormat = tickFormat.bind($$.api)
              : isTimeSeries && (currFormat = function (date) {
                return date ? format.axisTime(tickFormat)(date) : ''
              })
            : currFormat = isTimeSeries
              ? format.defaultAxisTime
              : isCategorized
                ? $$.categoryName
                : function (v) {
                  return v < 0 ? v.toFixed(0) : v
                }, isFunction(currFormat)
            ? function (v) {
          ...
          if (svg) {
            ...
            const isDomainSame = domain[0] === domain[1] && domain.every(function (v) {
              return v > 0
            })
            const isCurrentMaxTickDomainSame = isArray(currentTickMax.domain) && currentTickMax.domain[0] === currentTickMax.domain[1] && currentTickMax.domain.every(function (v) {
              return v > 0
            })
            ...
            const dummy = chart.append('svg').style('visibility', 'hidden').style('position', 'fixed').style('top', '0px').style('left', '0px')
          ...
          if ((axis.isCategorized() || axis.isTimeSeries()) && config.axis_x_tick_fit && !config.axis_x_tick_culling && !config.axis_x_tick_multiline && xAxisTickRotate > 0 && xAxisTickRotate < 90) {
            ...
            const maxOverflow = this.getXAxisTickMaxOverflow(xAxisTickRotate, widthWithoutCurrentPaddingLeft - defaultPadding)
          ...
          for (var $$ = this.owner, axis = $$.axis, config = $$.config, state = $$.state, isTimeSeries = axis.isTimeSeries(), tickTextWidths = state.current.maxTickWidths.x.ticks, tickCount = tickTextWidths.length, _state$axis$x$padding = state.axis.x.padding, left = _state$axis$x$padding.left, right = _state$axis$x$padding.right, maxOverflow = 0, remaining = tickCount - (isTimeSeries && config.axis_x_tick_fit ? 0.5 : 0), i = 0; i < tickCount; i++) {
            const tickIndex = i + 1
   ...
   */
        , _proto.getXAxisPadding = function getXAxisPadding (tickCount) {
          ...
          const config = $$.config
          const _$$$state2 = $$.state
          const width = _$$$state2.width
          const height = _$$$state2.height
          ...
          if (tickCount) {
            const targetCount = isFunction(tickCount) ? tickCount() : tickCount // compute ticks according to tickCount
            ...
            if (targetCount === 1) tickValues = [values[0]]; else if (targetCount === 2) tickValues = [values[0], values[values.length - 1]]; else if (targetCount > 2) {
              ...
              for (let i = 0; i < count; i++) tickValue = +start + (end - start) / (count + 1) * (i + 1), tickValues.push(forTimeSeries ? new Date(tickValue) : isCategorized ? Math.round(tickValue) : tickValue)
          ...
          const $$ = this.owner
          const axis = $$.$el.axis
          const _map = ['x', 'y', 'y2', 'subX'].map(function (v) {
            let ax = axis[v]
            ...
            if (axisScale) {
              ...
              if (axisScale.domain($$.getYDomain(targetsToShow, key, xDomainForZoom)), !tickValues && tickCount) {
                ...
                _axis.tickValues(_this5.generateTickValues(domain, domain.every(function (v) {
                  ...
                  ? 1
                  : tickCount, _this5.isTimeSeriesY()))
              }
            }
   ...
   */
        , _proto.setCulling = function setCulling () {
          ...
          const config = $$.config
          const _$$$state3 = $$.state
          const clip = _$$$state3.clip
          const current = _$$$state3.current
          const $el = $$.$el;
          ['subX', 'x', 'y', 'y2'].forEach(function (type) {
            const axis = $el.axis[type]
            const id = type === 'subX' ? 'x' : type
            const toCull = config['axis_' + id + '_tick_culling'] // subchart x axis should be aligned with x axis culling
 ...
 */
   ...
   */
        redrawEventRect: function redrawEventRect () {
          ...
          if ($el.eventRect) $$.updateEventRect($el.eventRect, !0); else {
            const eventRects = $$.$el.main.select('.' + config_classes.eventRects).style('cursor', config.zoom_enabled && config.zoom_type !== 'drag' ? config.axis_rotated ? 'ns-resize' : 'ew-resize' : null).classed(config_classes.eventRectsMultiple, isMultipleX).classed(config_classes.eventRectsSingle, !isMultipleX)
            const eventRectUpdate = eventRects.selectAll('.' + config_classes.eventRect).data([0]).enter().append('rect') // append event <rect>
          ...
          if (!isMultipleX) {
            ...
            const xAxisTickValues = $$.getMaxDataCountTarget() // update data's index value to be alinged with the x Axis
        ...
        bindTouchOnEventRect: function bindTouchOnEventRect (isMultipleX) {
          ...
          const state = $$.state
          const _$$$$el = $$.$el
          const eventRect = _$$$$el.eventRect
          const svg = _$$$$el.svg
          const selectRect = function (context) {
   ...
   */
        updateEventRect: function updateEventRect (eventRect, force) {
          ...
          const $el = $$.$el
          const _state = state
          const eventReceiver = _state.eventReceiver
          const width = _state.width
          const height = _state.height
          const rendered = _state.rendered
          const resizing = _state.resizing
   ...
   */
        updateEventRectData: function updateEventRectData () {
          ...
          { x = 0, y = 0, w = state.width, h = state.height } else {
            ...
            if ($$.axis.isCategorized()) {
              ...
              rectW = function (d) {
                const x = getPrevNextX(d) // if there this is a single data point make the eventRect full width (or height)
        ...
        selectRectForMultipleXs: function selectRectForMultipleXs (context) {
          ...
          if (!(state.dragging || $$.hasArcType(targetsToShow))) {
            ...
            const selectedData = sameXData.map(function (d) {
              return $$.addName(d)
   ...
   */
        unselectRect: function unselectRect () {
          ...
          const _$$$$el2 = $$.$el
          const bar = _$$$$el2.bar
          const circle = _$$$$el2.circle
          const tooltip = _$$$$el2.tooltip
   ...
   */
        generateEventRectsForSingleX: function generateEventRectsForSingleX (eventRectEnter) {
          ...
          const rect = eventRectEnter.style('cursor', config.data_selection_enabled && config.data_selection_grouped ? 'pointer' : null).on('click', function (event) {
            state.event = event
            const _eventReceiver = eventReceiver
            const currentIdx = _eventReceiver.currentIdx
            const data = _eventReceiver.data
   ...
   */
      ...
      const external_commonjs_d3_ease_commonjs2_d3_ease_amd_d3_ease_root_d3_ = __webpack_require__(11)
 ...
 */
   ...
   */
        generateFlow: function generateFlow (args) {
          ...
          const $el = $$.$el
          return function () {
            const flowLength = args.flow.length // set flag
   ...
   */
        setFlowList: function setFlowList (elements, args) {
          ...
          const _flow = flow
          const _flow$duration = _flow.duration
          const duration = _flow$duration === void 0 ? args.duration : _flow$duration
          const flowIndex = _flow.index
          const flowLength = _flow.length
          const orgDataCount = _flow.orgDataCount
          ...
          wait.add(Object.keys(elements).map(function (v) {
            return n = elements[v].transition().ease(external_commonjs_d3_ease_commonjs2_d3_ease_amd_d3_ease_root_d3_.easeLinear).duration(duration), n = v === 'axis.x'
              ? n.call(function (g) {
   ...
   */
        cleanUpFlow: function cleanUpFlow (elements, args) {
          ...
          const yForText = _shape$pos.yForText
          const _flow2 = flow
          const _flow2$done = _flow2.done
          const done = _flow2$done === void 0 ? function () {} : _flow2$done
          const flowLength = _flow2.length
          // draw again for removing flowed elements and reverting attr
          // callback for end of flow
          flowLength && (['circle', 'text', 'shape', 'eventRect'].forEach(function (v) {
            const target = []

            for (let i = 0; i < flowLength; i++) target.push('.' + config_classes[v] + '-' + i)
   ...
   */
        getFlowTransform: function getFlowTransform (targets, orgDataCount, flowIndex, flowLength) {
          ...
          const domain = $$.updateXDomain(targets, !0, !0)
 ...
 */
      ...
      /* harmony default export */ const clip = ({
        ...
        getClipPath: function getClipPath (id) {
          ...
          const isIE9 = !!win.navigator && win.navigator.appVersion.toLowerCase().indexOf('msie 9.') >= 0
   ...
   */
        ...
        updateXAxisTickClip: function updateXAxisTickClip () {
          ...
          const _$$$state3 = $$.state
          const clip = _$$$state3.clip
          const xAxisHeight = _$$$state3.xAxisHeight
          const defs = $$.$el.defs
        ...
        setXAxisTickClipWidth: function setXAxisTickClipWidth () {
          const $$ = this
          const config = $$.config
          const maxTickWidths = $$.state.current.maxTickWidths
          const xAxisTickRotate = $$.getAxisTickRotate('x')
        ...
        setXAxisTickTextClipPathWidth: function setXAxisTickTextClipPathWidth () {
          const $$ = this
          const _$$$state4 = $$.state
          const clip = _$$$state4.clip
          const current = _$$$state4.current
          const svg = $$.$el.svg
 ...
 */
      ...
      const getGridTextDx = function (d) {
 ...
 */
      ...
      /* harmony default export */ const grid = ({
        ...
        updateYGrid: function updateYGrid () {
          ...
          const state = $$.state
          const _$$$$el2 = $$.$el
          const grid = _$$$$el2.grid
          const main = _$$$$el2.main
          const isRotated = config.axis_rotated
        ...
        updateGrid: function updateGrid (duration) {
          const $$ = this
          const _$$$$el3 = $$.$el
          const grid = _$$$$el3.grid
          const gridLines = _$$$$el3.gridLines
          // hide if arc type
   ...
   */
        updateXGridLines: function updateXGridLines (duration) {
          ...
          const config = $$.config
          const _$$$$el4 = $$.$el
          const gridLines = _$$$$el4.gridLines
          const main = _$$$$el4.main
          const isRotated = config.axis_rotated
          config.grid_x_show && $$.updateXGrid()
          let xLines = main.select('.' + config_classes.xgridLines).selectAll('.' + config_classes.xgridLine).data(config.grid_x_lines) // exit
   ...
   */
        updateYGridLines: function updateYGridLines (duration) {
          ...
          let ygridLines = $el.main.select('.' + config_classes.ygridLines).selectAll('.' + config_classes.ygridLine).data(config.grid_y_lines) // exit
        ...
        initFocusGrid: function initFocusGrid () {
          ...
          const className = '.' + config_classes[isFront && $el.gridLines.main ? 'gridLines' : 'chart'] + (isFront ? ' + *' : '')
          const grid = $el.main.insert('g', className).attr('clip-path', clip.pathGrid).attr('class', config_classes.grid)
   ...
   */
        showGridFocus: function showGridFocus (data) {
          ...
          const config = $$.config
          const _$$$state3 = $$.state
          const width = _$$$state3.width
          const height = _$$$state3.height
          const isRotated = config.axis_rotated
          const focusEl = $$.$el.main.selectAll('line.' + config_classes.xgridFocus + ', line.' + config_classes.ygridFocus)
          const dataToShow = (data || [focusEl.datum()]).filter(function (d) {
            return d && isValue($$.getBaseValue(d))
          })
        ...
        hideGridFocus: function hideGridFocus () {
          const $$ = this
          const _$$$state4 = $$.state
          const inputType = _$$$state4.inputType
          const resizing = _$$$state4.resizing
          const main = $$.$el.main
        ...
        updateGridFocus: function updateGridFocus () {
          const $$ = this
          const _$$$state5 = $$.state
          const inputType = _$$$state5.inputType
          const width = _$$$state5.width
          const height = _$$$state5.height
          const resizing = _$$$state5.resizing
          const grid = $$.$el.grid
          const xgridFocus = grid.main.select('line.' + config_classes.xgridFocus)
          if (inputType === 'touch') xgridFocus.empty() ? resizing && $$.showCircleFocus() : $$.showGridFocus(); else {
            const _isRotated = $$.config.axis_rotated
        ...
        generateGridData: function generateGridData (type, scale) {
          const $$ = this
          const tickNum = $$.$el.main.select('.' + config_classes.axisX).selectAll('.tick').size()
          let gridData = []
          ...
          if (type === 'year') {
            ...
            for (let i = firstYear; i <= lastYear; i++) gridData.push(new Date(i + '-01-01 00:00:00'))
          } else {
            gridData = scale.ticks(10), gridData.length > tickNum && (gridData = gridData.filter(function (d) {
              return (d + '').indexOf('.') < 0
            }))
          }
        ...
        removeGridLines: function removeGridLines (params, forX) {
          ...
          const classLines = forX ? config_classes.xgridLines : config_classes.ygridLines
          const classLine = forX ? config_classes.xgridLine : config_classes.ygridLine
 ...
 */
      ...
      /* harmony default export */ const region = ({
        ...
        updateRegion: function updateRegion (duration) {
          ...
          // select <g> element
          let list = $el.main.select('.' + config_classes.regions).selectAll('.' + config_classes.region).data(config.regions)
 ...
 */
   ...
   */
        ...
        getHorizontalAxisHeight: function getHorizontalAxisHeight (id) {
          ...
          const _state = state
          const current = _state.current
          const rotatedPadding = _state.rotatedPadding
          const isLegendRight = _state.isLegendRight
          const isLegendInset = _state.isLegendInset
          const isRotated = config.axis_rotated
          let h = 30
          ...
          const rotate = $$.getAxisTickRotate(id) // Calculate x/y axis height when tick rotated
   ...
   */
        needToRotateXAxisTickTexts: function needToRotateXAxisTickTexts () {
          const $$ = this
          const _$$$state = $$.state
          const axis = _$$$state.axis
          const current = _$$$state.current
          const xAxisLength = current.width - $$.getCurrentPaddingLeft(!1) - $$.getCurrentPaddingRight()
 ...
 */
   ...
   */
      ...
      function axis_ownKeys (object, enumerableOnly) { const keys = Object.keys(object); if (Object.getOwnPropertySymbols) { let symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable })), keys.push.apply(keys, symbols) } return keys }
 ...
 */
      ...
      const api = [api_axis, api_category, grid_x, grid_y, flow, group, api_regions, x]
      const internal = [Axis, clip, eventrect, interactions_flow, grid, region, size_axis]
      const options = [data_axis, axis_axis, common_grid]
      // EXTERNAL MODULE: external {"commonjs":"d3-interpolate","commonjs2":"d3-interpolate","amd":"d3-interpolate","root":"d3"}
      const external_commonjs_d3_interpolate_commonjs2_d3_interpolate_amd_d3_interpolate_root_d3_ = __webpack_require__(12)
 ...
 */
      ...
      /* harmony default export */ const arc = ({
        initPie: function initPie () {
          ...
          const padAngle = ($$.hasType('pie') && padding ? padding * 0.01 : config[dataType + '_padAngle']) || 0
        ...
        updateRadius: function updateRadius () {
          ...
          state.radiusExpanded = Math.min(state.arcWidth, state.arcHeight) / 2 * ($$.hasMultiArcGauge() ? 0.85 : 1), state.radius = state.radiusExpanded * 0.95, state.innerRadiusRatio = w ? (state.radius - w) / state.radius : 0.6, state.gaugeArcWidth = w || (gaugeArcWidth <= state.radius - state.innerRadius ? state.radius - state.innerRadius : gaugeArcWidth <= state.radius ? gaugeArcWidth : state.radius)
          const innerRadius = config.pie_innerRadius || (padding ? padding * (state.innerRadiusRatio + 0.1) : 0) // NOTE: inner/outerRadius can be an object by user setting, only for 'pie' type
   ...
   */
        getRadius: function getRadius (d) {
          ...
          const data = d && d.data
          const _$$$state = $$.state
          let innerRadius = _$$$state.innerRadius
          let outerRadius = _$$$state.outerRadius
        ...
        getSvgArc: function getSvgArc () {
          ...
          const arc = (0, external_commonjs_d3_shape_commonjs2_d3_shape_amd_d3_shape_root_d3_.arc)().innerRadius(function (d) {
            const _$$$getRadius = $$.getRadius(d)
            const innerRadius = _$$$getRadius.innerRadius
            ...
            const outerRadius = _$$$getRadius2.outerRadius
        ...
        getSvgArcExpanded: function getSvgArcExpanded (rate) {
          ...
          const singleArcWidth = state.gaugeArcWidth / $$.filterTargetsToShow($$.data.targets).length
          const hasMultiArcGauge = $$.hasMultiArcGauge()
          const expandWidth = Math.min(state.radiusExpanded * newRate - state.radius, singleArcWidth * 0.8 - (1 - newRate) * 100)
          const arc = (0, external_commonjs_d3_shape_commonjs2_d3_shape_amd_d3_shape_root_d3_.arc)().innerRadius(function (d) {
            ...
            if (hasMultiArcGauge) radius = state.radius - singleArcWidth * d.index + expandWidth; else {
              const _$$$getRadius3 = $$.getRadius(d)
              const outerRadius = _$$$getRadius3.outerRadius
        ...
        transformForArcLabel: function transformForArcLabel (d) {
          const $$ = this
          const config = $$.config
          const radiusExpanded = $$.state.radiusExpanded
          const updated = $$.updateAngle(d)
          let translate = ''
          if (updated) {
            if ($$.hasMultiArcGauge()) {
              ...
              const _$$$getRadius4 = $$.getRadius(d)
              const outerRadius = _$$$getRadius4.outerRadius
              const c = this.svgArc.centroid(updated)
              var x = isNaN(c[0]) ? 0 : c[0]
              var y = isNaN(c[1]) ? 0 : c[1]
              const h = Math.sqrt(x * x + y * y)
              let ratio = $$.hasType('donut') && config.donut_label_ratio || $$.hasType('pie') && config.pie_label_ratio

              ratio = ratio ? isFunction(ratio) ? ratio.bind($$.api)(d, outerRadius, h) : ratio : outerRadius && (h ? (36 / outerRadius > 0.375 ? 1.175 - 36 / outerRadius : 0.8) * outerRadius / h : 0), translate = 'translate(' + x * ratio + ',' + y * ratio + ')'
            }
          }
          return translate
        },
        ...
        textForArcLabel: function textForArcLabel (selection) {
          ...
          $$.shouldShowArcLabel() && selection.style('fill', $$.updateTextColor.bind($$)).each(function (d) {
            ...
            const isUnderThreshold = $$.meetsLabelThreshold(ratio, $$.hasType('donut') && 'donut' || $$.hasType('gauge') && 'gauge' || $$.hasType('pie') && 'pie')
        ...
        expandArc: function expandArc (targetIds) {
          const $$ = this
          const transiting = $$.state.transiting
          const $el = $$.$el
   ...
   */
        getExpandConfig: function getExpandConfig (id, key) {
          ...
          const $$ = this
          const config = $$.config
          return $$.isDonutType(id) ? type = 'donut' : $$.isGaugeType(id) ? type = 'gauge' : $$.isPieType(id) && (type = 'pie'), type
            ? config[type + '_expand_' + key]
            : {
                duration: 50,
                rate: 0.98
              }[key]
        ...
        updateTargetsForArc: function updateTargetsForArc (targets) {
          ...
          const classArcs = $$.getClass('arcs', !0)
          const classFocus = $$.classFocus.bind($$)
          const chartArcs = $el.main.select('.' + config_classes.chartArcs)
          const mainPieUpdate = chartArcs.selectAll('.' + config_classes.chartArc).data($$.pie(targets)).attr('class', function (d) {
            return classChartArc(d) + classFocus(d.data)
          })
          const mainPieEnter = mainPieUpdate.enter().append('g').attr('class', classChartArc)
   ...
   */
        setArcTitle: function setArcTitle () {
          ...
          if (title) {
            const text = $$.$el.arcs.append('text').attr('class', config_classes[hasGauge ? 'chartArcsGaugeTitle' : 'chartArcsTitle']).style('text-anchor', 'middle')
            hasGauge && text.attr('dy', '-0.3em').style('font-size', '27px'), setTextValue(text, title, hasGauge ? undefined : [-0.6, 1.35], !0)
          }
        },
        redrawArc: function redrawArc (duration, durationForExit, withTransform) {
          ...
          let mainArc = main.selectAll('.' + config_classes.arcs).selectAll('.' + config_classes.arc).data($$.arcData.bind($$))
          // bind arc events
        ...
        redrawBackgroundArcs: function redrawBackgroundArcs () {
          ...
          let backgroundArc = $$.$el.arcs.select((hasMultiArcGauge ? 'g' : '') + '.' + config_classes.chartArcsBackground)
    ...
    function selectArc(_this, arcData, id) {
          ...
          if (arc.on('click', function (event, d, i) {
            ...
            const getEventArc = function (event) {
              const touch = event.changedTouches[0]
              const eventArc = (0, external_commonjs_d3_selection_commonjs2_d3_selection_amd_d3_selection_root_d3_.select)(browser_doc.elementFromPoint(touch.clientX, touch.clientY))
              return eventArc
            }
        ...
        redrawArcText: function redrawArcText (duration) {
          ...
          if (hasGauge && $$.data.targets.length === 1 && config.gauge_title || (text = main.selectAll('.' + config_classes.chartArc).select('text').style('opacity', '0').attr('class', function (d) {
            ...
            const isFullCircle = config.gauge_fullCircle
            isFullCircle && text && text.attr('dy', '' + (hasMultiArcGauge ? 0 : Math.round(state.radius / 14))), config.gauge_label_show && (arcs.select('.' + config_classes.chartArcsGaugeUnit).attr('dy', (isFullCircle ? 1.5 : 0.75) + 'em').text(config.gauge_units), arcs.select('.' + config_classes.chartArcsGaugeMin).attr('dx', -1 * (state.innerRadius + (state.radius - state.innerRadius) / (isFullCircle ? 1 : 2)) + 'px').attr('dy', '1.2em').text($$.textForGaugeMinMax(config.gauge_min, !1)), !isFullCircle && arcs.select('.' + config_classes.chartArcsGaugeMax).attr('dx', state.innerRadius + (state.radius - state.innerRadius) / 2 + 'px').attr('dy', '1.2em').text($$.textForGaugeMinMax(config.gauge_max, !0)))
          }
        }
      })
 ...
 */
      ...
      /* harmony default export */ const shape_area = ({
        ...
        updateAreaGradient: function updateAreaGradient () {
          const $$ = this
          const config = $$.config
          const datetimeId = $$.state.datetimeId
          const defs = $$.$el.defs
          $$.data.targets.forEach(function (d) {
            ...
            if ($$.isAreaType(d) && defs.select('#' + id).empty()) {
              const color = $$.color(d)
              const _config$area_linearGr = config.area_linearGradient
              const _config$area_linearGr2 = _config$area_linearGr.x
              const x = _config$area_linearGr2 === void 0 ? [0, 0] : _config$area_linearGr2
              const _config$area_linearGr3 = _config$area_linearGr.y
              const y = _config$area_linearGr3 === void 0 ? [0, 1] : _config$area_linearGr3
              const _config$area_linearGr4 = _config$area_linearGr.stops
              const stops = _config$area_linearGr4 === void 0 ? [[0, color, 1], [1, color, 0]] : _config$area_linearGr4
   ...
   */
        updateArea: function updateArea (durationForExit, isSub) {
          ...
          const area = $root.main.selectAll('.' + config_classes.areas).selectAll('.' + config_classes.area).data($$.lineData.bind($$))
   ...
   */
        redrawArea: function redrawArea (drawFn, withTransition, isSub) {
          ...
          const $$ = this
          const _ref = isSub ? this.$el.subchart : this.$el
          const area = _ref.area
          const orgAreaOpacity = $$.state.orgAreaOpacity
 ...
 */
      ...
      /* harmony default export */ const bar = ({
        ...
        updateTargetsForBar: function updateTargetsForBar (targets) {
          ...
          const classBars = $$.getClass('bars', !0)
          const classFocus = $$.classFocus.bind($$)
          const isSelectable = config.interaction_enabled && config.data_selection_isselectable
          $el.bar || $$.initBar()
          const mainBarUpdate = $$.$el.main.select('.' + config_classes.chartBars).selectAll('.' + config_classes.chartBar).data(targets).attr('class', function (d) {
            return classChartBar(d) + classFocus(d)
          })
          const mainBarEnter = mainBarUpdate.enter().append('g').attr('class', classChartBar).style('opacity', '0').style('pointer-events', 'none')
          // Bars for each data
   ...
   */
        updateBar: function updateBar (durationForExit, isSub) {
          ...
          const $$ = this
          const $root = isSub ? $$.$el.subchart : $$.$el
          const classBar = $$.getClass('bar', !0)
          const initialOpacity = $$.initialOpacity.bind($$)
          const bar = $root.main.selectAll('.' + config_classes.bars).selectAll('.' + config_classes.bar).data($$.labelishData.bind($$))
   ...
   */
        ...
        generateDrawBar: function generateDrawBar (barIndices, isSub) {
          ...
          return function (d, i) {
            ...
            const pathRadius = ['', '']
            let radius = 0 // switch points if axis is rotated, not applicable for sub chart
            ...
            const path = isRotated ? 'H' + (points[1][indexX] - radius) + ' ' + pathRadius[0] + 'V' + (points[2][indexY] - radius) + ' ' + pathRadius[1] + 'H' + points[3][indexX] : 'V' + (points[1][indexY] + (isNegative ? -radius : radius)) + ' ' + pathRadius[0] + 'H' + (points[2][indexX] - radius) + ' ' + pathRadius[1] + 'V' + points[3][indexY]
        ...
        generateGetBarPoints: function generateGetBarPoints (barIndices, isSub) {
          ...
          return function (d, i) {
            ...
            const startPosX = posX + width // 4 points that make a bar
        ...
        isWithinBar: function isWithinBar (that) {
          ...
          const _that$getBBox = that.getBBox()
          const width = _that$getBBox.width
          const height = _that$getBBox.height
          const isWithin = x - offset < mouse[0] && mouse[0] < x + width + offset && y - offset < mouse[1] && mouse[1] < y + height + offset
      ...
      function candlestick_ownKeys (object, enumerableOnly) { const keys = Object.keys(object); if (Object.getOwnPropertySymbols) { let symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable })), keys.push.apply(keys, symbols) } return keys }
 ...
 */
      ...
      /* harmony default export */ const candlestick = ({
   ...
   */
        updateTargetsForCandlestick: function updateTargetsForCandlestick (targets) {
          ...
          const mainUpdate = $$.$el.main.select('.' + config_classes.chartCandlesticks).selectAll('.' + config_classes.chartCandlestick).data(targets).attr('class', function (d) {
   ...
   */
        updateCandlestick: function updateCandlestick (durationForExit, isSub) {
          ...
          const $el = $$.$el
          const $root = isSub ? $el.subchart : $el
          const classSetter = $$.getClass('candlestick', !0)
          const initialOpacity = $$.initialOpacity.bind($$)
          const candlestick = $root.main.selectAll('.' + config_classes.chartCandlestick).selectAll('.' + config_classes.candlestick).data($$.labelishData.bind($$))
   ...
   */
        generateDrawCandlestick: function generateDrawCandlestick (indices, isSub) {
          ...
          return function (d, i, g) {
            ...
            const points = getPoints(d, i)
            const value = $$.getCandlestickData(d)
            const isUp = (_value = value) == null ? void 0 : _value._isUp
            const indexX = +isRotated
   ...
   */
        redrawCandlestick: function redrawCandlestick (drawFn, withTransition, isSub) {
          ...
          const _ref = isSub ? this.$el.subchart : this.$el
          const candlestick = _ref.candlestick
          const rand = getRandom(!0)

          return [candlestick.each(function (d, i) {
            const g = withTransition ? (0, external_commonjs_d3_selection_commonjs2_d3_selection_amd_d3_selection_root_d3_.select)(this).transition(rand) : (0, external_commonjs_d3_selection_commonjs2_d3_selection_amd_d3_selection_root_d3_.select)(this)
            drawFn(d, i, g)
          }).style('opacity', '1')]
        },
   ...
   */
        getCandlestickData: function getCandlestickData (_ref2) {
          ...
          if (isArray(value)) {
            ...
            const low = value[2]
            const close = value[3]
            const _value$ = value[4]
            const volume = _value$ !== void 0 && _value$
            d = {
              open,
              high,
              low,
 ...
 */
      ...
      /* harmony default export */ const gauge = ({
        initGauge: function initGauge () {
          ...
          const config = $$.config
          const arcs = $$.$el.arcs
          const appendText = function (className) {
        ...
        redrawMultiArcGauge: function redrawMultiArcGauge () {
          ...
          const $el = $$.$el
          const hiddenTargetIds = $$.state.hiddenTargetIds
          const arcLabelLines = $el.main.selectAll('.' + config_classes.arcs).selectAll('.' + config_classes.arcLabelLine).data($$.arcData.bind($$))
          const mainArcLabelLine = arcLabelLines.enter().append('rect').attr('class', function (d) {
 ...
 */
      ...
      /* harmony default export */ const line = ({
        ...
        updateTargetsForLine: function updateTargetsForLine (t) {
          const $$ = this
          const _$$$$el = $$.$el
          const area = _$$$$el.area
          const line = _$$$$el.line
          const main = _$$$$el.main
          const classChartLine = $$.getChartClass('Line')
          const classLines = $$.getClass('lines', !0)
          const classFocus = $$.classFocus.bind($$)
          line || $$.initLine()
          const targets = t.filter(function (d) {
            return !($$.isScatterType(d) || $$.isBubbleType(d))
          })
          const mainLineUpdate = main.select('.' + config_classes.chartLines).selectAll('.' + config_classes.chartLine).data(targets).attr('class', function (d) {
            return classChartLine(d) + classFocus(d)
          })
          const mainLineEnter = mainLineUpdate.enter().append('g').attr('class', classChartLine).style('opacity', '0').style('pointer-events', 'none')
          // Lines for each data
   ...
   */
        updateLine: function updateLine (durationForExit, isSub) {
          isSub === void 0 && (isSub = !1)
          const $$ = this
          const extraLineClasses = $$.format.extraLineClasses
          const $el = $$.$el
          const $root = isSub ? $el.subchart : $el
          const line = $root.main.selectAll('.' + config_classes.lines).selectAll('.' + config_classes.line).data($$.lineData.bind($$))
   ...
   */
        getCurve: function getCurve (d) {
          ...
          return isRotatedStepType ? function (context) {
            const step = $$.getInterpolate(d)(context) // keep the original method
        ...
        lineWithRegions: function lineWithRegions (d, x, y, _regions) {
          ...
          const regions = []
          const dasharray = '2 2'
          const isWithinRegions = function (withinX, withinRegions) {
          ...
          const generateM = function (points) {
          ...
          for (var data, _i = 0; data = d[_i]; _i++) {
            ...
            if (isValue(data.value)) // Draw as normal
            {
              if (isUndefined(regions) || !style || !hasPrevData) path += '' + (_i && hasPrevData ? 'L' : 'M') + xValue(data) + ',' + yValue(data); else if (hasPrevData) {
                ...
                for (let _j = diff; _j <= 1; _j += diffx2) path += sWithRegion(prevData, data, _j, diff), _j + diffx2 >= 1 && (path += sWithRegion(prevData, data, 1, 0))
              }
            }
          }
 ...
 */
      ...
      /* harmony default export */ const point = ({
        ...
        initialOpacityForCircle: function initialOpacityForCircle (d) {
          const config = this.config
          const withoutFadeIn = this.state.withoutFadeIn
        ...
        updateTargetForCircle: function updateTargetForCircle (targetsValue, enterNodeValue) {
          ...
          const classCircles = $$.getClass('circles', !0)
          ...
          if (config.point_show) {
            ...
            if (!targets) {
              ...
              const mainCircle = $el.main.select('.' + config_classes.chartCircles).style('pointer-events', 'none').selectAll('.' + config_classes.circles).data(targets).attr('class', classCircles)
        ...
        updateCircle: function updateCircle (isSub) {
          ...
          if (config.point_show && !state.toggling) {
            const circles = $root.main.selectAll('.' + config_classes.circles).selectAll('.' + config_classes.circle).data(function (d) {
        ...
        redrawCircle: function redrawCircle (cx, cy, withTransition, flow, isSub) {
          ...
          const $el = $$.$el
          const $root = isSub ? $el.subchart : $el
          const selectedCircles = $root.main.selectAll('.' + config_classes.selectedCircle)
   ...
   */
        showCircleFocus: function showCircleFocus (d) {
          ...
          const _$$$state = $$.state
          const hasRadar = _$$$state.hasRadar
          const resizing = _$$$state.resizing
          const toggling = _$$$state.toggling
          const transiting = _$$$state.transiting
          const $el = $$.$el
          ...
          if (transiting === !1 && config.point_focus_only && circle) {
            ...
            const fn = $$.point('update', $$, cx, cy, $$.color, !resizing && withTransition)
            d && (circle = circle.filter(function (t) {
              const data = d.filter(function (v) {
                return v.id === t.id
              })
   ...
   */
        ...
        expandCircles: function expandCircles (i, id, reset) {
          ...
          const circles = $$.getCircles(i, id).classed(config_classes.EXPANDED, !0)
          ...
          $$.isCirclePoint()
            ...
            : circles.each(function () {
              ...
              if (this.tagName === 'circle') point.attr('r', r); else {
                ...
                const width = _this$getBBox.width
                const height = _this$getBBox.height
        ...
        unexpandCircles: function unexpandCircles (i) {
          const $$ = this
          const r = $$.pointR.bind($$)
          const circles = $$.getCircles(i).filter(function () {
        ...
        isWithinCircle: function isWithinCircle (node, r) {
          ...
          if (!(cx || cy) && node.nodeType === 1) {
            ...
            const x = _getBoundingRect.x
            const y = _getBoundingRect.y
        ...
        insertPointInfoDefs: function insertPointInfoDefs (point, id) {
          const $$ = this
          const copyAttr = function (from, target) {
        ...
        updatePointClass: function updatePointClass (d) {
          ...
          const circle = $$.$el.circle
          let pointClass = !1
          return (isObject(d) || circle) && (pointClass = d === !0
        ...
        generatePoint: function generatePoint () {
          ...
          return function (method, context) {
            ...
            return function (d) {
              const id = $$.getTargetSelectorSuffix(d.id || d.data && d.data.id || d)
        ...
        custom: {
          ...
          update: function update (element, xPosFn, yPosFn, fillStyleFn, withTransition, flow, selectedCircles) {
            const _element$node$getBBox = element.node().getBBox()
            const width = _element$node$getBBox.width
            const height = _element$node$getBBox.height
            const xPosFn2 = function (d) {
 ...
 */
      ...
      /* harmony default export */ const radar = ({
        ...
        getRadarSize: function getRadarSize () {
          ...
          const config = $$.config
          const _$$$state = $$.state
          const arcWidth = _$$$state.arcWidth
          const arcHeight = _$$$state.arcHeight
   ...
   */
        generateRadarPoints: function generateRadarPoints () {
          ...
          const _$$$getRadarSize2 = $$.getRadarSize()
          const width = _$$$getRadarSize2[0]
          const height = _$$$getRadarSize2[1]
        ...
        updateRadarLevel: function updateRadarLevel () {
          ...
          const _$$$getRadarSize3 = $$.getRadarSize()
          const width = _$$$getRadarSize3[0]
          const height = _$$$getRadarSize3[1]
          ...
          const levelRatio = levelData.map(function (l) {
            return radius * ((l + 1) / depth)
          })
          const levelTextFormat = (config.radar_level_text_format || function () {}).bind($$.api)
          const points = levelData.map(function (v) {
            const range = levelRatio[v]
            const pos = getRange(0, edge).map(function (i) {
              return $$.getRadarPosition(['x', 'y'], i, range, 1).join(',')
            })
            return pos.join(' ')
          })
          const level = radarLevels.selectAll('.' + config_classes.level).data(levelData)
        ...
        updateRadarAxes: function updateRadarAxes () {
          ...
          const config = $$.config
          const radar = $$.$el.radar
          const _$$$getRadarSize4 = $$.getRadarSize()
          const width = _$$$getRadarSize4[0]
          const height = _$$$getRadarSize4[1]
          ...
          if (config.radar_axis_line_show && axisEnter.append('line'), config.radar_axis_text_show && axisEnter.append('text'), axis = axisEnter.merge(axis), config.radar_axis_line_show && axis.select('line').attr('x1', width).attr('y1', height).attr('x2', function (d, i) {
            ...
            const _config$radar_axis_te2 = _config$radar_axis_te.x
            const x = _config$radar_axis_te2 === void 0 ? 0 : _config$radar_axis_te2
            const _config$radar_axis_te3 = _config$radar_axis_te.y
            const y = _config$radar_axis_te3 === void 0 ? 0 : _config$radar_axis_te3
            axis.select('text').style('text-anchor', 'middle').attr('dy', '.5em').call(function (selection) {
              selection.each(function (d) {
                setTextValue((0, external_commonjs_d3_selection_commonjs2_d3_selection_amd_d3_selection_root_d3_.select)(this), d + '', [-0.6, 1.2])
              })
            }).datum(function (d, i) {
              return {
                index: i
        ...
        bindEvent: function bindEvent () {
          ...
          const _state = state
          const inputType = _state.inputType
          const transiting = _state.transiting

          if (config.interaction_enabled) {
            const isMouse = inputType === 'mouse'
            const getIndex = function (event) {
              let target = event.target; // in case of multilined axis text
        ...
        updateRadarShape: function updateRadarShape (durationForExit) {
          const $$ = this
          const targets = $$.data.targets.filter(function (d) {
 ...
 */
      /* harmony default export */ const shape_candlestick = ({
        /**
 ...
 */
      ...
      var resolver_shape_line = function () {
        return extendLine(), (resolver_shape_line = function () {
          return TYPE.LINE
        })()
      }
      var shape_spline = function () {
   ...
   */
        select: function select (ids, indices, resetOther) {
          ...
          config.data_selection_enabled && $el.main.selectAll('.' + config_classes.shapes).selectAll('.' + config_classes.shape).each(function (d, i) {
            ...
            const isSelected = shape.classed(config_classes.SELECTED)
 ...
 */
     ...
     */
          show: function () {
            const $$ = this.internal
            const subchart = $$.$el.subchart
            const config = $$.config
            const show = config.subchart_show

            if (!show) {
              config.subchart_show = !show, subchart.main || $$.initSubchart()
              let $target = subchart.main.selectAll('.' + config_classes.target) // need to cover when new data has been loaded
     ...
     */
      ...
      const external_commonjs_d3_zoom_commonjs2_d3_zoom_amd_d3_zoom_root_d3_ = __webpack_require__(14)
   ...
   */
        unzoom: function unzoom () {
          ...
          if ($$.scale.zoom) {
            ...
            // reset transform
            const eventRects = $$.$el.main.select('.' + config_classes.eventRects);
      ...
      const external_commonjs_d3_color_commonjs2_d3_color_amd_d3_color_root_d3_ = __webpack_require__(13)
 ...
 */
        ...
        drag: function drag (mouse) {
          ...
          if (!$$.hasArcType() && config.data_selection_enabled && ( // do nothing if not selectable
            ...
            main.select('.' + config_classes.dragarea).attr('x', minX).attr('y', minY).attr('width', maxX - minX).attr('height', maxY - minY), main.selectAll('.' + config_classes.shapes).selectAll('.' + config_classes.shape).filter(function (d) {
              ...
              const shape = (0, external_commonjs_d3_selection_commonjs2_d3_selection_amd_d3_selection_root_d3_.select)(this)
              const isSelected = shape.classed(config_classes.SELECTED)
              const isIncluded = shape.classed(config_classes.INCLUDED)
              let isWithin = !1
              ...
              if (shape.classed(config_classes.circle)) {
                ...
                const _x = _getPathBox.x
                var y = _getPathBox.y
                const width = _getPathBox.width
                const height = _getPathBox.height
   ...
   */
      ...
      function selection_ownKeys (object, enumerableOnly) { const keys = Object.keys(object); if (Object.getOwnPropertySymbols) { let symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable })), keys.push.apply(keys, symbols) } return keys }
   ...
   */
        selectPath: function selectPath (target, d) {
          ...
          callFn(config.data_onselected, $$.api, d, target.node()), config.interaction_brighten && target.transition().duration(100).style('fill', function () {
            return (0, external_commonjs_d3_color_commonjs2_d3_color_amd_d3_color_root_d3_.rgb)($$.color(d)).brighter(0.75)
          })
        },
        ...
        toggleShape: function toggleShape (that, d, i) {
          ...
          if (config.data_selection_enabled && config.data_selection_isselectable.bind($$.api)(d)) {
            if (!config.data_selection_multiple) {
              let selector = '.' + config_classes.shapes
 ...
 */
      ...
      /* harmony default export */ const interactions_subchart = ({
        /**
   ...
   */
        initBrush: function initBrush () {
          ...
          const getBrushSize = function () {
            const brush = $$.$el.svg.select('.' + config_classes.brush + ' .overlay')
            const brushSize = {
              width: 0,
              height: 0
            }
          ...
          $$.brush.on('start', function () {
            ...
            !extent && scale.range
              ...
              : isArray(extent) && (extent = extent.map(function (v, i) {
                return [v, i > 0 ? h : i]
   ...
   */
        updateTargetsForSubchart: function updateTargetsForSubchart (targets) {
          ...
          config.subchart_show && (['bar', 'line', 'bubble', 'candlestick', 'scatter'].filter(function (v) {
            ...
            const chartClass = $$.getChartClass(name, !0)
            const shapeClass = $$.getClass(isPointType ? 'circles' : v + 's', !0)
   ...
   */
        redrawSubchart: function redrawSubchart (withSubchart, duration, shape) {
          ...
          if (main.style('visibility', config.subchart_show ? 'visible' : 'hidden'), config.subchart_show && (state.event && state.event.type === 'zoom' && $$.brush.update(), withSubchart && (brushEmpty($$) || $$.brush.update(), Object.keys(shape.type).forEach(function (v) {
            const name = capitalize(v)
            const drawFn = $$['generateDraw' + name](shape.indices[v], !0)
   ...
   */
        redrawForBrush: function redrawForBrush () {
          const $$ = this
          const _$$$config = $$.config
          const onBrush = _$$$config.subchart_onbrush
          const withY = _$$$config.zoom_rescale
          const scale = $$.scale
          $$.redraw({
            withTransition: !1,
            withY,
   ...
   */
        getExtent: function getExtent () {
          ...
          if (extent) {
            if (isFunction(extent)) extent = extent.bind($$.api)($$.getXDomain($$.data.targets), scale.subX); else if ($$.axis.isTimeSeries() && extent.every(isNaN)) {
              const fn = parseDate.bind($$)
 ...
 */
   ...
   */
        bindZoomEvent: function bindZoomEvent (bind) {
          ...
          const main = $$.$el.main
          const zoomEnabled = config.zoom_enabled
          const eventRects = main.select('.' + config_classes.eventRects)
   ...
   */
     ...
     */
          ...
          zoom.orgScaleExtent = function () {
            ...
            const newScale = transform[config.axis_rotated ? 'rescaleY' : 'rescaleX'](org.xScale || scale.x)
   ...
   */
        initZoomBehaviour: function initZoomBehaviour () {
          ...
          $$.zoomBehaviour = (0, external_commonjs_d3_drag_commonjs2_d3_drag_amd_d3_drag_root_d3_.drag)().clickDistance(4).on('start', function (event) {
            ...
            if (state.event = event, $$.setDragStatus(!1), zoomRect.attr(prop.axis, 0).attr(prop.attr, 0), start > end && (_ref = [end, start], start = _ref[0], end = _ref[1], _ref), start < 0 && (end += Math.abs(start), start = 0), start !== end) {
              $$.api.zoom([start, end].map(function (v) {
                return scale.invert(v)
              })), $$.onZoomEnd(event)
            } else if ($$.isMultipleX()) $$.clickHandlerForMultipleXS.bind(this)($$); else {
              const _getPointer = getPointer(event)
              const x = _getPointer[0]
              const y = _getPointer[1]
              const target = browser_doc.elementFromPoint(x, y)
        ...
        setZoomResetButton: function setZoomResetButton () {
          ...
          resetButton && config.zoom_type === 'drag' && ($$.zoom.resetBtn
            ? $$.zoom.resetBtn.style('display', null)
            : $$.zoom.resetBtn = $$.$el.chart.append('div').classed(config_classes.button, !0).append('span').on('click', function () {
