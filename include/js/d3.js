...
(function (global, factory) {
  ...
  class Adder {
    ...
    valueOf () {
      const p = this._partials
      let n = this._n; let x; let y; let lo; let hi = 0
      if (n > 0) {
        hi = p[--n]
        while (n > 0) {
          x = hi
  ...
  const array$5 = Array.prototype

  const slice$4 = array$5.slice
  ...
  function ticks (start, stop, count) {
    ...
    if (step > 0) {
      let r0 = Math.round(start / step); let r1 = Math.round(stop / step)
      if (r0 * step < start) ++r0
      if (r1 * step > stop) --r1
  ...
  function quantile$1 (values, p, valueof) {
    ...
    const value0 = max$3(quickselect(values, i0).subarray(0, i0 + 1))
    const value1 = min$2(values.subarray(i0 + 1))
  ...
  function shuffler (random) {
    return function shuffle (array, i0 = 0, i1 = array.length) {
      let m = i1 - (i0 = +i0)
      while (m) {
        const i = random() * m-- | 0; const t = array[m + i0]
  ...
  function disjoint (values, other) {
    const iterator = other[Symbol.iterator](); const set = new Set()
  ...
  function superset (values, other) {
    const iterator = values[Symbol.iterator](); const set = new Set()
  ...
  function axis (orient, scale) {
    ...
    function axis (context) {
      ...
      const format = tickFormat == null ? (scale.tickFormat ? scale.tickFormat.apply(scale, tickArguments) : identity$8) : tickFormat
      const spacing = Math.max(tickSizeInner, 0) + tickPadding
      const range = scale.range()
      const range0 = +range[0] + offset
      const range1 = +range[range.length - 1] + offset
      const position = (scale.bandwidth ? center$1 : number$2)(scale.copy(), offset)
      ...
      if (context !== selection) {
        ...
        tickEnter
          .attr('opacity', epsilon$5)
          .attr('transform', function (d) { let p = this.parentNode.__axis; return transform((p && isFinite(p = p(d)) ? p : position(d)) + offset) })
      }
  ...
  Dispatch.prototype = dispatch.prototype = {
    ...
    on: function (typename, callback) {
      const _ = this._
      const T = parseTypenames$1(typename + '', _)
      let t
      let i = -1
      const n = T.length
  ...
  function namespace (name) {
    let prefix = name += ''; const i = prefix.indexOf(':')
  ...
  const find$1 = Array.prototype.find
  ...
  function selection_selectChildren (match) {
    return this.selectAll(match == null
      ? children
  ...
  function selection_data (value, key) {
    ...
    for (var m = groups.length, update = new Array(m), enter = new Array(m), exit = new Array(m), j = 0; j < m; ++j) {
      ...
      const groupLength = group.length
      const data = array$4(value.call(parent, parent && parent.__data__, j, parents))
      const dataLength = data.length
  ...
  function selection_join (onenter, onupdate, onexit) {
    let enter = this.enter(); let update = this; const exit = this.exit()
  ...
  function selection_attr (name, value) {
    ...
    return this.each((value == null
      ? (fullname.local ? attrRemoveNS$1 : attrRemove$1)
  ...
  function classedAdd (node, names) {
    const list = classList(node); let i = -1; const n = names.length
  ...
  function selection_classed (name, value) {
    ...
    if (arguments.length < 2) {
      const list = classList(this.node()); let i = -1; const n = names.length
  ...
  function selection_cloneShallow () {
    const clone = this.cloneNode(false); const parent = this.parentNode
    return parent ? parent.insertBefore(clone, this.nextSibling) : clone
  }

  function selection_cloneDeep () {
    const clone = this.cloneNode(true); const parent = this.parentNode
    return parent ? parent.insertBefore(clone, this.nextSibling) : clone
  }
  ...
  function onAdd (typename, value, options) {
    return function () {
      const on = this.__on; let o; const listener = contextListener(value)
      if (on) {
  ...
  function selection_on (typename, value, options) {
    const typenames = parseTypenames(typename + ''); let i; const n = typenames.length; let t
  ...
  function dragDisable (view) {
    ...
    const selection = select(view).on('dragstart.drag', noevent$2, true)
  ...
  function drag () {
    ...
    function mousemoved (event) {
      noevent$2(event)
      if (!mousemoving) {
        const dx = event.clientX - mousedownx; const dy = event.clientY - mousedowny
    ...
    function touchstarted (event, d) {
      ...
      const n = touches.length; let i; let gesture
    ...
    function beforestart (that, container, event, d, identifier, touch) {
      ...
      let p = pointer(touch || event, container); let dx; let dy
      let s
  ...
  const t0$1 = 4 / 29
  const t1$1 = 6 / 29
  const t2 = 3 * t1$1 * t1$1
  const t3 = t1$1 * t1$1 * t1$1
  ...
  function labConvert (o) {
    ...
    const y = xyz2lab((0.2225045 * r + 0.7168786 * g + 0.0606169 * b) / Yn); let x; let z
  ...
  function hclConvert (o) {
    ...
    const h = Math.atan2(o.b, o.a) * degrees$2
  ...
  function cubehelixConvert (o) {
    ...
    const h = s ? Math.atan2(k, bl) * degrees$2 - 120 : NaN
  ...
  define(Cubehelix, cubehelix$3, extend(Color, {
    ...
    rgb: function () {
      const h = isNaN(this.h) ? 0 : (this.h + 120) * radians$1
      const l = +this.l
  ...
  const rgbBasis = rgbSpline(basis$2)
  const rgbBasisClosed = rgbSpline(basisClosed$1)
  ...
  function interpolateTransform (parse, pxComma, pxParen, degParen) {
    ...
    return function (a, b) {
      ...
      a = b = null // gc
      return function (t) {
        let i = -1; const n = q.length; let o
  ...
  // p0 = [ux0, uy0, w0]
    ...
    zoom.rho = function (_) {
      const _1 = Math.max(1e-3, +_); const _2 = _1 * _1; const _4 = _2 * _2
  ...
  function cubehelix$1 (hue) {
    return (function cubehelixGamma (y) {
      ...
      function cubehelix (start, end) {
        const h = hue((start = cubehelix$3(start)).h, (end = cubehelix$3(end)).h)
        const s = nogamma(start.s, end.s)
        const l = nogamma(start.l, end.l)
        const opacity = nogamma(start.opacity, end.opacity)
        return function (t) {
  ...
  function piecewise (interpolate, values) {
    ...
    let i = 0; const n = values.length - 1; let v = values[0]; const I = new Array(n < 0 ? 0 : n)
  ...
  let timeout$1 = 0 // is a timeout pending?
  let interval$1 = 0 // are any timers active?
  ...
  function poke () {
    const now = clock.now(); const delay = now - clockLast
    if (delay > pokeDelay) clockSkew -= delay, clockLast = now
  }

  function nap () {
    let t0; let t1 = taskHead; let t2; let time = Infinity
    while (t1) {
      if (t1._call) {
  ...
  function interval (callback, delay, time) {
    const t = new Timer(); let total = delay
  ...
  function attrFunction (name, interpolate, value) {
    let string00,
      ...
      interpolate0
    return function () {
      let string0; const value1 = value(this); let string1
  ...
  function transition_attr (name, value) {
    const fullname = namespace(name); const i = fullname === 'transform' ? interpolateTransformSvg : interpolate$1
  ...
  function onFunction (id, name, listener) {
    let on0; let on1; const sit = start(name) ? init : set
    return function () {
  ...
  const Selection = selection.prototype.constructor
  ...
  function styleMaybeRemove (id, name) {
    let on0; let on1; let listener0; const key = 'style.' + name; const event = 'end.' + key; let remove
    return function () {
      const schedule = set(this, id)
      const on = schedule.on
  ...
  function transition_end () {
    let on0; let on1; const that = this; const id = that._id; let size = that.size()
    return new Promise(function (resolve, reject) {
      const cancel = { value: reject }
      const end = { value: function () { if (--size === 0) resolve() } }
  ...
  const tau$5 = 2 * Math.PI
  const amplitude = 1
  const period = 0.3

  const elasticIn = (function custom (a, p) {
    const s = Math.asin(1 / (a = Math.max(1, a))) * (p /= tau$5)
  ...
  function brush$1 (dim) {
      ...
      if (group.tween) {
        group
          ...
          .tween('brush', function () {
            ...
            const i = interpolate$2(selection0, selection1)
    ...
    function started (event) {
      ...
      let mode = (keys && event.metaKey ? type = 'overlay' : type) === 'selection' ? MODE_DRAG : (keys && event.altKey ? MODE_CENTER : MODE_HANDLE)
      ...
      let lockX
      let lockY
      const points = Array.from(event.touches || [event], t => {
      ...
      function move (event) {
        const point = points[0]; const point0 = point.point0
        let t
  ...
  function chord$1 (directed, transpose) {
    ...
    function chord (matrix) {
      ...
      const groupIndex = range$1(0, n)
      let chords = new Array(n * n)
  ...
  const tauEpsilon = tau$3 - epsilon$3
  ...
  function ribbon (headRadius) {
    let source = defaultSource$1
    let target = defaultTarget
    let sourceRadius = defaultRadius$1
    let targetRadius = defaultRadius$1
    let startAngle = defaultStartAngle
    let endAngle = defaultEndAngle
    let padAngle = defaultPadAngle
    let context = null

    function ribbon () {
      let buffer
      const s = source.apply(this, arguments)
      const t = target.apply(this, arguments)
      const ap = padAngle.apply(this, arguments) / 2
      const argv = slice$2.call(arguments)
      const sr = +sourceRadius.apply(this, (argv[0] = s, argv))
      let sa0 = startAngle.apply(this, argv) - halfPi$2
      let sa1 = endAngle.apply(this, argv) - halfPi$2
      const tr = +targetRadius.apply(this, (argv[0] = t, argv))
      let ta0 = startAngle.apply(this, argv) - halfPi$2
      let ta1 = endAngle.apply(this, argv) - halfPi$2
      ...
      if (sa0 !== ta0 || sa1 !== ta1) {
        if (headRadius) {
          const hr = +headRadius.apply(this, arguments); const tr2 = tr - hr; const ta2 = (ta0 + ta1) / 2
  ...
  function area$3 (ring) {
    let i = 0; const n = ring.length; let area = ring[n - 1][1] * ring[0][0] - ring[n - 1][0] * ring[0][1]
  ...
  function contains$2 (ring, hole) {
    let i = -1; const n = hole.length; let c
    while (++i < n) if (c = ringContains(ring, hole[i])) return c
    return 0
  }

  function ringContains (ring, point) {
    const x = point[0]; const y = point[1]; let contains = -1
    for (let i = 0, n = ring.length, j = n - 1; i < n; j = i++) {
      const pi = ring[i]; const xi = pi[0]; const yi = pi[1]; const pj = ring[j]; const xj = pj[0]; const yj = pj[1]
  ...
  function segmentContains (a, b, c) {
    let i; return collinear$1(a, b, c) && within(a[i = +(a[0] === b[0])], c[i], b[i])
  }
  ...
  function contours () {
    ...
    function contours (values) {
      ...
      if (!Array.isArray(tz)) {
        const domain = extent$1(values); const start = domain[0]; const stop = domain[1]
    ...
    contours.size = function (_) {
      ...
      const _0 = Math.floor(_[0]); const _1 = Math.floor(_[1])
  ...
  class Voronoi {
    ...
    _init () {
      ...
      let p0; let p1 = h * 4
      let x0; let x1 = points[2 * h]
      let y0; let y1 = points[2 * h + 1]
      vectors.fill(0)
    ...
    render (context) {
      ...
      let h0; let h1 = hull[hull.length - 1]
      for (let i = 0; i < hull.length; ++i) {
        h0 = h1, h1 = hull[i]
    ...
    * neighbors (i) {
    ...
    _clipFinite (i, points) {
      const n = points.length
      let P = null
      let x0; let y0; let x1 = points[n - 2]; let y1 = points[n - 1]
      let c0; let c1 = this._regioncode(x1, y1)
      let e0, e1
      for (let j = 0; j < n; j += 2) {
    ...
    _edge (i, e0, e1, P, j) {
      ...
      if (P.length > 4) {
        for (let i = 0; i < P.length; i += 2) {
          const j = (i + 2) % P.length; const k = (i + 4) % P.length
          if (P[i] === P[j] && P[j] === P[k] ||
        P[i + 1] === P[j + 1] && P[j + 1] === P[k + 1]) { P.splice(j, 2), i -= 2 }
        }
      }
      return j
    }
    ...
    _project (x0, y0, vx, vy) {
      let t = Infinity; let c; let x; let y
      if (vy < 0) { // top
  ...
  const tau$2 = 2 * Math.PI; const pow$2 = Math.pow
  ...
  class Delaunay {
    ...
    _init () {
      const d = this._delaunator; const points = this.points

      // check for collinear
      if (d.hull && d.hull.length > 2 && collinear(d)) {
        this.collinear = Int32Array.from({ length: points.length / 2 }, (_, i) => i)
          .sort((i, j) => points[2 * i] - points[2 * j] || points[2 * i + 1] - points[2 * j + 1]) // for exact neighbors
        const e = this.collinear[0]; const f = this.collinear[this.collinear.length - 1]
        const bounds = [points[2 * e], points[2 * e + 1], points[2 * f], points[2 * f + 1]]
        const r = 1e-8 * Math.hypot(bounds[3] - bounds[1], bounds[2] - bounds[0])
        for (let i = 0, n = points.length / 2; i < n; ++i) {
    ...
    * neighbors (i) {
    ...
    renderHull (context) {
      ...
      const h = hull[0] * 2; const n = hull.length
  ...
  function pad$1 (value, width) {
    const s = value + ''; const length = s.length
  ...
  function formatDate (date) {
    ...
    return isNaN(date)
      ...
      (milliseconds
        ? 'T' + pad$1(hours, 2) + ':' + pad$1(minutes, 2) + ':' + pad$1(seconds, 2) + '.' + pad$1(milliseconds, 3) + 'Z'
        : seconds
          ? 'T' + pad$1(hours, 2) + ':' + pad$1(minutes, 2) + ':' + pad$1(seconds, 2) + 'Z'
          : minutes || hours
  ...
  function dsvFormat (delimiter) {
    ...
    function parse (text, f) {
      let convert; let columns; const rows = parseRows(text, function (row, i) {
  ...
  const csv$1 = dsvFormat(',')

  const csvParse = csv$1.parse
  const csvParseRows = csv$1.parseRows
  const csvFormat = csv$1.format
  const csvFormatBody = csv$1.formatBody
  const csvFormatRows = csv$1.formatRows
  const csvFormatRow = csv$1.formatRow
  const csvFormatValue = csv$1.formatValue

  const tsv$1 = dsvFormat('\t')

  const tsvParse = tsv$1.parse
  const tsvParseRows = tsv$1.parseRows
  const tsvFormat = tsv$1.format
  const tsvFormatBody = tsv$1.formatBody
  const tsvFormatRows = tsv$1.formatRows
  const tsvFormatRow = tsv$1.formatRow
  const tsvFormatValue = tsv$1.formatValue

  function autoType (object) {
    for (const key in object) {
      let value = object[key].trim(); var number; var m
      if (!value) value = null
  ...
  const csv = dsvParse(csvParse)
  const tsv = dsvParse(tsvParse)
  ...
  function collide (radius) {
    ...
    function force () {
      ...
      function apply (quad, x0, y0, x1, y1) {
        const data = quad.data; let rj = quad.r; let r = ri + rj
        if (data) {
    ...
    function initialize () {
      if (!nodes) return
      let i; const n = nodes.length; let node
      radii = new Array(n)
    ...
    function initializeNodes () {
      for (var i = 0, n = nodes.length, node; i < n; ++i) {
        ...
        if (isNaN(node.x) || isNaN(node.y)) {
          const radius = initialRadius * Math.sqrt(0.5 + i); const angle = i * initialAngle
  ...
  function manyBody () {
    ...
    function force (_) {
      let i; const n = nodes.length; const tree = quadtree(nodes, x$2, y$2).visitAfter(accumulate)
    ...
    function accumulate (quad) {
      let strength = 0; let q; let c; let weight = 0; let x; let y; let i
  ...
  function formatDecimalParts (x, p) {
    ...
    let i; const coefficient = x.slice(0, i)
  ...
  function formatLocale$1 (locale) {
    const group = locale.grouping === undefined || locale.thousands === undefined ? identity$6 : formatGroup(map.call(locale.grouping, Number), locale.thousands + '')
    ...
    const numerals = locale.numerals === undefined ? identity$6 : formatNumerals(map.call(locale.numerals, String))
  ...
  const quarterPi = pi$1 / 4
  const tau$1 = pi$1 * 2

  const degrees = 180 / pi$1
  const radians = pi$1 / 180
  ...
  const sign$1 = Math.sign || function (x) { return x > 0 ? 1 : x < 0 ? -1 : 0 }
  ...
  const streamObjectType = {
    ...
    FeatureCollection: function (object, stream) {
      const features = object.features; let i = -1; const n = features.length
  ...
  var streamGeometryType = {
    ...
    MultiPoint: function (object, stream) {
      const coordinates = object.coordinates; let i = -1; const n = coordinates.length
    ...
    GeometryCollection: function (object, stream) {
      const geometries = object.geometries; let i = -1; const n = geometries.length
      while (++i < n) streamGeometry(geometries[i], stream)
    }
  }

  function streamLine (coordinates, stream, closed) {
    let i = -1; const n = coordinates.length - closed; let coordinate
    stream.lineStart()
  ...
  function streamPolygon (coordinates, stream) {
    let i = -1; const n = coordinates.length
    stream.polygonStart()
  ...
  function cartesian (spherical) {
    const lambda = spherical[0]; const phi = spherical[1]; const cosPhi = cos$1(phi)
  ...
  function cartesianNormalizeInPlace (d) {
    const l = sqrt$2(d[0] * d[0] + d[1] * d[1] + d[2] * d[2])
    d[0] /= l, d[1] /= l, d[2] /= l
  }

  let lambda0$1, phi0, lambda1, phi1, // bounds
  ...
  function linePoint (lambda, phi) {
    ...
    if (p0) {
      ...
      let phii
      const antimeridian = abs$1(delta) > 180
  ...
  function centroidLinePoint (lambda, phi) {
    ...
    const z = sin$1(phi)
    var w = atan2$1(sqrt$2((w = y0$4 * z - z0 * y) * w + (w = z0 * x - x0$4 * z) * w + (w = x0$4 * y - y0$4 * x) * w), x0$4 * x + y0$4 * y + z0 * z)
    W1 += w
    X1$1 += w * (x0$4 + (x0$4 = x))
    Y1$1 += w * (y0$4 + (y0$4 = y))
    Z1$1 += w * (z0 + (z0 = z))
  ...
  function centroidRingPoint (lambda, phi) {
    ...
    const y = cosPhi * sin$1(lambda)
    const z = sin$1(phi)
    const cx = y0$4 * z - z0 * y
    const cy = z0 * x - x0$4 * z
    const cz = x0$4 * y - y0$4 * x
    const m = hypot(cx, cy, cz)
    const w = asin$1(m) // line weight = angle
  ...
  function circleRadius (cosRadius, point) {
    ...
    const radius = acos$1(-point[1])
    return ((-point[2] < 0 ? -radius : radius) + tau$1 - epsilon$1) % tau$1
  }

  function circle$2 () {
    let center = constant$3([0, 0])
    let radius = constant$3(90)
    let precision = constant$3(6)
    let ring
    let rotate
    const stream = { point }
  ...
  function clipRejoin (segments, compareIntersection, startInside, interpolate, stream) {
    ...
    segments.forEach(function (segment) {
      ...
      let n; let p0 = segment[0]; const p1 = segment[n]; let x
  ...
  function longitude (point) {
    if (abs$1(point[0]) <= pi$1) { return point[0] } else { return sign$1(point[0]) * ((abs$1(point[0]) + pi$1) % tau$1 - pi$1) }
  }
  ...
  function polygonContains (polygon, point) {
    ...
    for (let i = 0, n = polygon.length; i < n; ++i) {
      ...
      for (let j = 0; j < m; ++j, lambda0 = lambda1, sinPhi0 = sinPhi1, cosPhi0 = cosPhi1, point0 = point1) {
        ...
        const antimeridian = absDelta > pi$1
        ...
        if (antimeridian ^ lambda0 >= lambda ^ lambda1 >= lambda) {
          ...
          const phiArc = (antimeridian ^ delta >= 0 ? -1 : 1) * asin$1(intersection[2])
  ...
  function clipAntimeridianLine (stream) {
    ...
    return {
      ...
      point: function (lambda1, phi1) {
        const sign1 = lambda1 > 0 ? pi$1 : -pi$1
        const delta = abs$1(lambda1 - lambda0)
  ...
  function clipAntimeridianInterpolate (from, to, direction, stream) {
    ...
    if (from == null) {
      ...
      const lambda = from[0] < to[0] ? pi$1 : -pi$1
  ...
  function clipCircle (radius) {
    ...
    const notHemisphere = abs$1(cr) > epsilon$1 // TODO optimise for this common case
    ...
    function intersect (a, b, two) {
      ...
      const delta = lambda1 - lambda0
      const polar = abs$1(delta - pi$1) < epsilon$1
      const meridian = polar || delta < epsilon$1
    ...
    function code (lambda, phi) {
      const r = smallRadius ? radius : pi$1 - radius
      let code = 0
  ...
  const clipMax = 1e9; const clipMin = -clipMax
  ...
  function lengthPoint$1 (lambda, phi) {
    ...
    const sinPhi = sin$1(phi)
    const cosPhi = cos$1(phi)
    const delta = abs$1(lambda - lambda0)
  ...
  const object = { type: 'LineString', coordinates }
  ...
  function graticuleX (y0, y1, dy) {
    const y = sequence(y0, y1 - epsilon$1, dy).concat(y1)
    return function (x) { return y.map(function (y) { return [x, y] }) }
  }

  function graticuleY (x0, x1, dx) {
    const x = sequence(x0, x1 - epsilon$1, dx).concat(x1)
  ...
  function graticule () {
    ...
    graticule.lines = function () {
      return lines().map(function (coordinates) { return { type: 'LineString', coordinates } })
    }
  ...
  function interpolate (a, b) {
    ...
    const d = 2 * asin$1(sqrt$2(haversin(y1 - y0) + cy0 * cy1 * haversin(x1 - x0)))
    const k = sin$1(d)
  ...
  function centroidPointLine (x, y) {
    const dx = x - x0$1; const dy = y - y0$1; const z = sqrt$2(dx * dx + dy * dy)
    X1 += z * (x0$1 + x) / 2
    Y1 += z * (y0$1 + y) / 2
    Z1 += z
    centroidPoint(x0$1 = x, y0$1 = y)
  ...
  function resample$1 (project, delta2) {
    function resampleLineTo (x0, y0, lambda0, a0, b0, c0, x1, y1, lambda1, a1, b1, c1, depth, stream) {
      ...
      if (d2 > 4 * delta2 && depth--) {
        ...
        let b = b0 + b1
        let c = c0 + c1
        const m = sqrt$2(a * a + b * b + c * c)
        const phi2 = asin$1(c /= m)
        const lambda2 = abs$1(abs$1(c) - 1) < epsilon$1 || abs$1(lambda0 - lambda1) < epsilon$1 ? (lambda0 + lambda1) / 2 : atan2$1(b, a)
    ...
    return function (stream) {
      let lambda00, x00, y00, a00, b00, c00, // first point
      ...
      function linePoint (lambda, phi) {
        const c = cartesian([lambda, phi]); const p = project(lambda, phi)
  ...
  const transformRadians = transformer$3({
    point: function (x, y) {
  ...
  function projectionMutator (projectAt) {
    ...
    let alpha = 0 // post-rotate angle
    let sx = 1 // reflectX
    let sy = 1 // reflectX
    let theta = null; let preclip = clipAntimeridian // pre-clip angle
    let x0 = null; let y0; let x1; let y1; let postclip = identity$5 // post-clip extent
    ...
    function recenter () {
      ...
      const transform = scaleTranslateRotate(k, x - center[0], y - center[1], sx, sy, alpha)
  ...
  function conicEqualAreaRaw (y0, y1) {
    const sy0 = sin$1(y0); const n = (sy0 + sin$1(y1)) / 2

    // Are the parallels symmetrical around the Equator?
    if (abs$1(n) < epsilon$1) return cylindricalEqualAreaRaw(y0)

    const c = 1 + sy0 * (2 * n - sy0); const r0 = sqrt$2(c) / n

    function project (x, y) {
      const r = sqrt$2(c - 2 * n * sin$1(y)) / n
      return [r * sin$1(x *= n), r0 - r * cos$1(x)]
    }

    project.invert = function (x, y) {
      const r0y = r0 - y
      let l = atan2$1(x, abs$1(r0y)) * sign$1(r0y)
  ...
  function albersUsa () {
    ...
    let point; const pointStream = { point: function (x, y) { point = [x, y] } }
    ...
    albersUsa.translate = function (_) {
      ...
      const k = lower48.scale(); const x = +_[0]; const y = +_[1]
  ...
  function mercatorProjection (project) {
    ...
    const scale = m.scale
    const translate = m.translate
    const clipExtent = m.clipExtent
  ...
  function conicConformalRaw (y0, y1) {
    const cy0 = cos$1(y0)
    const n = y0 === y1 ? sin$1(y0) : log$1(cy0 / cos$1(y1)) / log$1(tany(y1) / tany(y0))
    const f = cy0 * pow$1(tany(y0), n) / n

    if (!n) return mercatorRaw

    function project (x, y) {
      if (f > 0) { if (y < -halfPi$1 + epsilon$1) y = -halfPi$1 + epsilon$1 } else { if (y > halfPi$1 - epsilon$1) y = halfPi$1 - epsilon$1 }
      const r = f / pow$1(tany(y), n)
      return [r * sin$1(n * x), f - r * cos$1(n * x)]
    }

    project.invert = function (x, y) {
      const fy = f - y; const r = sign$1(n) * sqrt$2(x * x + fy * fy)
      let l = atan2$1(x, abs$1(fy)) * sign$1(fy)
  ...
  function conicEquidistantRaw (y0, y1) {
    ...
    function project (x, y) {
      const gy = g - y; const nx = n * x
      return [gy * sin$1(nx), g - gy * cos$1(nx)]
    }

    project.invert = function (x, y) {
      const gy = g - y
      let l = atan2$1(x, abs$1(gy)) * sign$1(gy)
  ...
  function equalEarthRaw (lambda, phi) {
    const l = asin$1(M * sin$1(phi)); const l2 = l * l; const l6 = l2 * l2 * l2
    return [
  ...
  equalEarthRaw.invert = function (x, y) {
    let l = y; let l2 = l * l; let l6 = l2 * l2 * l2
  ...
  function gnomonicRaw (x, y) {
    const cy = cos$1(y); const k = cos$1(x) * cy
  ...
  function identity$4 () {
    let k = 1; let tx = 0; let ty = 0; let sx = 1; let sy = 1 // scale, translate and reflect
    let alpha = 0; let ca; let sa // angle
    let x0 = null; let y0; let x1; let y1 // clip extent
    let kx = 1; let ky = 1
    const transform = transformer$3({
      point: function (x, y) {
        const p = projection([x, y])
        this.stream.point(p[0], p[1])
      }
    })
    let postclip = identity$5
    let cache
    let cacheStream
  ...
  function naturalEarth1Raw (lambda, phi) {
    const phi2 = phi * phi; const phi4 = phi2 * phi2
    return [
  ...
  naturalEarth1Raw.invert = function (x, y) {
    let phi = y; let i = 25; let delta
    do {
      var phi2 = phi * phi; const phi4 = phi2 * phi2
  ...
  function stereographicRaw (x, y) {
    const cy = cos$1(y); const k = 1 + cos$1(x) * cy
    return [cy * sin$1(x) / k, sin$1(y) / k]
  }
  ...
  function node_eachBefore (callback, that) {
    let node = this; const nodes = [node]; let children; let i; let index = -1
    while (node = nodes.pop()) {
      callback.call(that, node, ++index, this)
  ...
  function node_eachAfter (callback, that) {
    let node = this; const nodes = [node]; const next = []; let children; let i; let n; let index = -1
    while (node = nodes.pop()) {
      next.push(node)
      if (children = node.children) {
  ...
  function node_ancestors () {
    let node = this; const nodes = [node]
  ...
  function * node_iterator () {
    let node = this; let current; let next = [node]; let children; let i; let n
    do {
  ...
  function enclose (circles) {
    let i = 0; const n = (circles = shuffle(Array.from(circles))).length; let B = []; let p; let e
  ...
  function intersects (a, b) {
    const dr = a.r + b.r - 1e-6; const dx = b.x - a.x; const dy = b.y - a.y
    return dr > 0 && dr * dr > dx * dx + dy * dy
  }
  ...
  function binary (parent, x0, y0, x1, y1) {
    const nodes = parent.children
    let i; const n = nodes.length
    let sum; const sums = new Array(n + 1)
  ...
  const gamma = (function sourceRandomGamma (source) {
    ...
    function randomGamma (k, theta) {
      ...
      const multiplier = k < 1 ? () => Math.pow(source(), 1 / k) : () => 1
      return function () {
        do {
          do {
            var x = randomNormal()
  ...
  function ordinal () {
    ...
    function scale (d) {
      const key = d + ''; let i = index.get(key)
      if (!i) {
  ...
  function bimap (domain, range, interpolate) {
    let d0 = domain[0]; const d1 = domain[1]; let r0 = range[0]; const r1 = range[1]
  ...
  function transformer$2 () {
    let domain = unit
    let range = unit
    let interpolate = interpolate$2
    let transform
    let untransform
    let unknown
    let clamp = identity$3
    let piecewise
    let output
    let input
  ...
  function symlogish (transform) {
    let c = 1; const scale = transform(transformSymlog(c), transformSymexp(c))
  ...
  function powish (transform) {
    const scale = transform(identity$3, identity$3)
    let exponent = 1
  ...
  function quantile () {
    ...
    function rescale () {
      let i = 0; const n = Math.max(1, range.length)
  ...
  const millisecond = newInterval(function () {
  // noop
  }, function (date, step) {
  ...
  const durationMinute$1 = 6e4
  const durationHour$1 = 36e5
  const durationDay$1 = 864e5
  const durationWeek$1 = 6048e5

  const second = newInterval(function (date) {
  ...
  const minute = newInterval(function (date) {
  ...
  const hour = newInterval(function (date) {
  ...
  const month = newInterval(function (date) {
    date.setDate(1)
    date.setHours(0, 0, 0, 0)
  }, function (date, step) {
  ...
  const year = newInterval(function (date) {
    date.setMonth(0, 1)
    date.setHours(0, 0, 0, 0)
  }, function (date, step) {
  ...
  const utcMinute = newInterval(function (date) {
  ...
  const utcHour = newInterval(function (date) {
  ...
  const utcDay = newInterval(function (date) {
  ...
  const utcMonth = newInterval(function (date) {
    date.setUTCDate(1)
    date.setUTCHours(0, 0, 0, 0)
  }, function (date, step) {
  ...
  const utcYear = newInterval(function (date) {
        ...
        : minute(date) < date
          ...
          : hour(date) < date
            ...
            : day(date) < date
              ? formatHour
              : month(date) < date
                ? (week(date) < date ? formatDay : formatWeek)
                : year(date) < date
                  ? formatMonth
                  : formatYear)(date)
    }
  ...
  function sequential () {
    const scale = linearish(transformer$1()(identity$3))
  ...
  function diverging$1 () {
    const scale = linearish(transformer()(identity$3))
  ...
  const cubehelix = cubehelixLong(cubehelix$3(300, 0.5, 0.0), cubehelix$3(-240, 0.5, 1.0))

  const warm = cubehelixLong(cubehelix$3(-100, 0.75, 0.35), cubehelix$3(80, 1.50, 0.8))

  const cool = cubehelixLong(cubehelix$3(260, 0.75, 0.35), cubehelix$3(80, 1.50, 0.8))

  const c$2 = cubehelix$3()
  ...
  function pie () {
    ...
    let sort = null
    let startAngle = constant$1(0)
    let endAngle = constant$1(tau)
    let padAngle = constant$1(0)
  ...
  const curveRadialLinear = curveRadial$1(curveLinear)
  ...
  function link (curve) {
    ...
    function link () {
      let buffer; const argv = slice.call(arguments); const s = source.apply(this, argv); const t = target.apply(this, argv)
      if (!context) context = buffer = path()
  ...
  const kr = Math.sin(pi / 10) / Math.sin(7 * pi / 10)
  ...
  BasisOpen.prototype = {
    ...
    point: function (x, y) {
      ...
      switch (this._point) {
        ...
        case 1: this._point = 2; break
        case 2: this._point = 3; var x0 = (this._x0 + 4 * this._x1 + x) / 6; var y0 = (this._y0 + 4 * this._y1 + y) / 6; this._line ? this._context.lineTo(x0, y0) : this._context.moveTo(x0, y0); break
  ...
  function none (series) {
    let n = series.length; const o = new Array(n)
    while (--n >= 0) o[n] = n
    return o
  }
  ...
  function stack () {
    ...
    function stack (data) {
      ...
      let i; const n = sz.length; let j = -1
      let oz
  ...
  function peak (series) {
    let i = -1; let j = 0; const n = series.length; let vi; let vj = -Infinity
  ...
  function sum (series) {
    let s = 0; let i = -1; const n = series.length; let v
  ...
  function zoom () {
    ...
    function translate (transform, p0, p1) {
      const x = p0[0] - p1[0] * transform.k; const y = p0[1] - p1[1] * transform.k
      ...
      transition
        ...
        .tween('zoom', function () {
          ...
          return function (t) {
            ...
            else { const l = i(t); const k = w / l[2]; t = new Transform(k, p[0] - l[0] * k, p[1] - l[1] * k) }
            g.zoom(null, t)
          }
        })
    }
    ...
    function mousedowned (event, ...args) {
      ...
      const g = gesture(this, args, true).event(event)
      ...
      function mousemoved (event) {
        noevent(event)
        if (!g.moved) {
          const dx = event.clientX - x0; const dy = event.clientY - y0
    ...
    function dblclicked (event, ...args) {
      ...
      const t1 = constrain(translate(scale(t0, k1), p0, p1), extent.apply(this, args), translateExtent)
    ...
    function touchstarted (event, ...args) {
      ...
      const g = gesture(this, args, event.changedTouches.length === n).event(event)
    ...
    function touchmoved (event, ...args) {
      ...
      const g = gesture(this, args).event(event)
      const touches = event.changedTouches
      const n = touches.length; let i; let t; let p; let l
    ...
    function touchended (event, ...args) {
      ...
      const g = gesture(this, args).event(event)
      const touches = event.changedTouches
      const n = touches.length; let i; let t
